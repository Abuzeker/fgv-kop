...
export const Merge_quatity = (originalDataArray, responseData) => {
    return originalDataArray.map(originalData => {
        ...
        enrichedData['Today Quantity'] = enrichedData['Today Quantity'] ? enrichedData['Today Quantity']:0
        enrichedData['Todate Quantity'] = enrichedData['Todate Quantity'] ? enrichedData['Todate Quantity']:0
        enrichedData['Today Targeted Quantity'] = enrichedData['Today Targeted Quantity'] ? enrichedData['Today Targeted Quantity']:0
