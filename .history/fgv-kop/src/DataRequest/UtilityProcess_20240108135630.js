...
export const Caculate_ShipmentCompletion = (data) => {
  ...
  const todateProduced = data["Todate Produced"];

  console.log(todateProduced);

  // // Initialize objects to store total target and total produced for each product
  // const totalTarget = {};
  // const totalProduced = {};

  // // Loop through each entry in the "Todate Produced" array
  // todateProduced.forEach(entry => {
  //   const product = entry.product;
  //   const target = parseFloat(entry.Target);
  //   const produced = parseFloat(entry.produced);
