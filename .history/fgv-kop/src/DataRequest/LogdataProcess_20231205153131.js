...
export const merge_log_and_order = (OrderDetails, QuantityLog) => {
    ...
    const processed_data = OrderDetails.map(OrderDetail => {
        ...
        // enrichedData["Daily Quantity"]['Today Quantity'] = enrichedData["Daily Quantity"]['Today Quantity'] ? enrichedData["Daily Quantity"]['Today Quantity']:0
        // enrichedData["Daily Quantity"]['Todate Quantity'] = enrichedData["Daily Quantity"]['Todate Quantity'] ? enrichedData["Daily Quantity"]['Todate Quantity']:0
        // enrichedData["Daily Quantity"]['Today Targeted Quantity'] = enrichedData["Daily Quantity"]['Today Targeted Quantity'] ? enrichedData["Daily Quantity"]['Today Targeted Quantity']:0
        return enrichedData
    })
