...
const VacuumHMI = ({value}) => {
  ...
  if(value['F391A RUN'] === "True"){f391a = "#92d050"}
  else if (value['F391A TRIP'] === "True"){f391a = 'Red'}
  else{f391a = 'Grey'}

  if(value['F391B RUN'] === "True"){f391b = "#92d050"}
  else if (value['F391B TRIP'] === "True"){f391b = 'Red'}
  else{f391b = 'Grey'}
