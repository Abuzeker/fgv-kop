...
const Deo2HMI = ({value}) => {
    return (
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width='100%' height='100%' viewBox="2 2 1920 1080">
                <defs>
                ...
                <g stroke="#839292">
                    <path
                        ...
                        transform="translate(996.537 253.185)"
                    />
                    <path
                        fill="url(#a)"
                        d="M83.8 0h47.1l85.2 42.7H0L83.8 0z"
                        transform="translate(996.88 202.778)"
                    />
                    <path
                        fill="url(#b)"
                        d="M1.8 0h47.1c1 0 1.8.7 1.8 1.6v1.6c0 .9-.8 1.7-1.8 1.7H1.8C.8 4.9 0 4.1 0 3.2V1.6C0 .7.8 0 1.8 0z"
                        transform="translate(1078.777 197.886)"
                    />
                    <path
                        fill="url(#b)"
                        d="M2.9 0h230.3c1.6 0 3 .7 3 1.7v4.4c0 .9-1.4 1.7-3 1.7H2.9C1.3 7.8 0 7 0 6.1V1.7C0 .7 1.3 0 2.9 0z"
                        transform="translate(986.825 516.079)"
                    />
                    <path
                        fill="url(#b)"
                        d="M2.9 0h230.3c1.6 0 3 .7 3 1.7v4.4c0 .9-1.4 1.7-3 1.7H2.9C1.3 7.8 0 7 0 6.1V1.7C0 .7 1.3 0 2.9 0z"
                        transform="translate(986.825 245.402)"
                    />
                    <path
                        fill="url(#b)"
                        d="M2.9 0h209.3c1.7 0 3 .8 3 1.7v3.4c0 1-1.3 1.7-3 1.7H2.9C1.3 6.8 0 6.1 0 5.1V1.7C0 .8 1.3 0 2.9 0z"
                        transform="translate(997.321 298.768)"
                    />
                    <path
                        fill="url(#c)"
                        d="M2.9 0h209.3c1.7 0 3 .8 3 1.7v3.4c0 1-1.3 1.7-3 1.7H2.9C1.3 6.8 0 6.1 0 5.1V1.7C0 .8 1.3 0 2.9 0z"
                        transform="translate(997.321 352.157)"
                    />
                    <path
                        fill="url(#b)"
                        d="M2.9 0h209.3c1.7 0 3 .8 3 1.7v3.4c0 1-1.3 1.7-3 1.7H2.9C1.3 6.8 0 6.1 0 5.1V1.7C0 .8 1.3 0 2.9 0z"
                        transform="translate(997.321 406.845)"
                    />
                    <path
                        fill="url(#d)"
                        d="M2.9 0h209.3c1.7 0 3 .8 3 1.7v3.4c0 1-1.3 1.7-3 1.7H2.9C1.3 6.8 0 6.1 0 5.1V1.7C0 .8 1.3 0 2.9 0z"
                        transform="translate(997.321 460.882)"
                    />
                    <path
                        fill="url(#a)"
                        d="M0 31C0 13.9 13.9 0 31.1 0c17.1 0 31.1 13.9 31.1 31s-14 30.9-31.1 30.9C13.9 61.9 0 48.1 0 31z"
                        transform="translate(1073.824 268.647)"
                    />
                    <path
                        fill="url(#e)"
                        d="M0 24.4C0 10.9 10.9 0 24.5 0c13.4 0 24.4 10.9 24.4 24.4 0 13.4-11 24.3-24.4 24.3C10.9 48.7 0 37.8 0 24.4z"
                        transform="rotate(180 564.678 161.994)"
                    />
                    <path
                        fill="url(#a)"
                        d="M0 31C0 13.9 13.9 0 31.1 0c17.1 0 31.1 13.9 31.1 31s-14 30.9-31.1 30.9C13.9 61.9 0 48.1 0 31z"
                        transform="translate(1073.824 380.07)"
                    />
                    <path
                        fill="url(#e)"
                        d="M0 24.4C0 10.9 10.9 0 24.5 0c13.4 0 24.4 10.9 24.4 24.4 0 13.4-11 24.3-24.4 24.3C10.9 48.7 0 37.8 0 24.4z"
                        transform="rotate(180 564.678 217.707)"
                    />
                    <path
                        fill="url(#b)"
                        d="M0 0h9.5v24.8H0l.6-2.7h6.9V2.7H.6L0 0z"
                        transform="rotate(-90 753.66 -283.961)"
                    />
                    <path
                        fill="url(#f)"
                        d="M1.7 0h93.5c.9 0 1.7.5 1.7 1.2V53c0 .7-.8 1.3-1.7 1.3H1.7c-1 0-1.7-.6-1.7-1.3V1.2C0 .5.7 0 1.7 0z"
                        transform="translate(1001.597 468.444)"
                    />
                    <path
                        fill="url(#f)"
                        d="M0 0h103.5v7H0V0z"
                        transform="translate(998.27 516.917)"
                    />
                </g>
                <g fill="none" stroke="#000">
                    <path d="m1092.851 297.288 12.1-12.9 12.1 12.9M1104.942 284.388v12.9" />
                </g>
                <path
                    fill="url(#g)"
                    d="M.4 0h73.3c.2 0 .4.2.4.4v2.8c0 .2-.2.3-.4.3H.4c-.2 0-.4-.1-.4-.3V.4C0 .2.2 0 .4 0z"
                    transform="translate(1067.063 260.978)"
                />
                <path
                    fill="url(#h)"
                    d="M0 0h11.3v2.5H0V0z"
                    transform="translate(1098.911 264.35)"
                />
                <path
                    fill="url(#h)"
                    d="M0 0h10v6.9H0V0z"
                    transform="translate(1099.533 266.877)"
                />
                <path
                    fill="url(#h)"
                    d="M0 0h9.3v4.6H0V0z"
                    transform="translate(1099.883 273.746)"
                />
                <path
                    fill="url(#i)"
                    d="M.1 0h9.2c.1 0 .2.1.2.1v.3s-.1.1-.2.1H.1L0 .4V.1L.1 0z"
                    transform="translate(1099.81 278.199)"
                />
                <path
                    fill="url(#j)"
                    d="M0 0h9.3v.4H0V0z"
                    transform="translate(1099.883 273.77)"
                />
                <path
                    fill="url(#j)"
                    d="M0 0h10v.4H0V0z"
                    transform="translate(1099.546 266.877)"
                />
                <path
                    fill="url(#h)"
                    d="M0 0h5.5v.6H0V0z"
                    transform="translate(1101.719 278.69)"
                />
                <g fill="none" stroke="#008ccc" strokeDasharray="2,5">
                    <path d="m1094.637 289.033 9.9-9.6 9.9 9.8M1104.584 279.433v9.6" />
                </g>
                <g fill="none" stroke="#000">
                    <path d="m1091.32 420.308 12.1-12.9 12.1 12.9M1103.41 407.408v12.9" />
                </g>
                <path
                    fill="url(#g)"
                    d="M.4 0h73.3c.2 0 .4.2.4.4v2.8c0 .2-.2.3-.4.3H.4c-.2 0-.4-.1-.4-.3V.4C0 .2.2 0 .4 0z"
                ...
                <path
                    fill="url(#h)"
                    d="M0 0h11.3v2.5H0V0z"
                    transform="translate(1097.777 389.788)"
                />
                <path
                    fill="url(#h)"
                    d="M0 0h10v6.9H0V0z"
                ...
                <path
                    fill="url(#h)"
                    d="M0 0h9.3v4.6H0V0z"
                    transform="translate(1098.748 399.184)"
                />
                <path
                    fill="url(#i)"
                    d="M.1 0h9.2c.1 0 .2.1.2.1v.3s-.1.1-.2.1H.1L0 .4V.1L.1 0z"
                    transform="translate(1098.675 403.637)"
                />
                <path
                    fill="url(#j)"
                    d="M0 0h9.3v.4H0V0z"
                    transform="translate(1098.748 399.208)"
                />
                <path
                    fill="url(#j)"
                    d="M0 0h10v.4H0V0z"
                    transform="translate(1098.411 392.315)"
                />
                <path
                    fill="url(#h)"
                    d="M0 0h5.5v.6H0V0z"
                    transform="translate(1100.584 404.128)"
                />
                <g fill="none" stroke="#008ccc" strokeDasharray="2,5">
                    <path d="m1093.502 414.47 9.9-9.6 9.9 9.8M1103.45 404.87v9.6" />
                </g>
                <g stroke="#92d050">
                    <path fill="none" strokeWidth={4} d="M1154.113 262.608h690.8" />
                    <path
                        fill="#92d050"
                        strokeLinecap="round"
                        d="m1154.113 268.608-12-6 12-6v12"
                    />
                </g>
                <g stroke="#236ea1">
                    <path fill="none" strokeWidth={2.667} d="M1149.757 388.045h100.4" />
                    <path
                        fill="#236ea1"
                        strokeLinecap="round"
                        d="m1149.757 392.945-9.8-4.9 9.8-4.9v9.8"
                    />
                </g>
                <path
                    fill="none"
                ...
                />
                <path fill="#fff" d="M1345.523 143.955h76.5v26.4h-76.5v-26.4z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1345.523 143.955)"
                >
                    <tspan
                        x={13.2}
                        y={19.2}
                ...
                <path
                    fill="#00b0f0"
                    stroke="#00b0f0"
                    d="M1283.047 391.687h-11.5v4.2l-17.1-8.4 17.1-8.4v4.2h11.5v8.4z"
                />
                <path fill="#fff" d="M1289.601 366.36h149.9v42.6h-149.9v-42.6z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1289.601 366.36)"
                >
                    <tspan
                        x={30.9}
                        y={27.3}
                ...
                />
                <g stroke="#92d050">
                    <path fill="none" strokeWidth={4} d="M1213.316 489.115h78.2" />
                    <path
                        fill="#92d050"
                        strokeLinecap="round"
                        d="m1300.316 489.115-10.4-6c1 1.8 1.6 3.8 1.6 6s-.6 4.2-1.6 6l10.4-6"
                    />
                </g>
                <path
                    fill="#92d050"
                ...
                />
                <path fill="#fff" d="M1338.026 475.645h94.5v26.4h-94.5v-26.4z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1338.026 475.645)"
                >
                    <tspan
                        x={23.2}
                        y={19.2}
                ...
                <path
                    ...
                    transform="translate(1264.515 466.456)"
                />
                <path
                    fill="url(#l)"
                    d="M0 0h1.1v13.1H0V0z"
                    transform="translate(1271.752 493.743)"
                />
                <path
                    fill="url(#m)"
                    d="M0 0h4.4v.8H0V0z"
                    transform="translate(1270.1 478.57)"
                />
                <path
                    fill="url(#l)"
                    d="M0 0h3.2v8.2H0V0z"
                    transform="translate(1270.672 479.374)"
                />
                <path
                    fill="url(#m)"
                    d="M.3 0h15.1c.2 0 .3.1.3.2v.3c0 .1-.1.2-.3.2H.3C.1.7 0 .6 0 .5V.2C0 .1.1 0 .3 0z"
                    transform="translate(1264.377 466.189)"
                />
                <path
                    fill="url(#n)"
                    d="M.3 0h10.8c.1 0 .3.1.3.2v4c0 .1-.2.2-.3.2H.3c-.2 0-.3-.1-.3-.2v-4C0 .1.1 0 .3 0z"
                    transform="translate(1266.61 470.346)"
                />
                <path fill="#3e3938" d="M1267.183 470.748h10.2v3.6h-10.2v-3.6z" />
                <path
                    fill="url(#o)"
                    d="M.1 0h15.5s.1 0 .1.1v1.2c0 .1-.1.1-.1.1H.1c-.1 0-.1 0-.1-.1V.1C0 0 0 0 .1 0z"
                    transform="translate(1264.461 477.242)"
                />
                <g fill="url(#p)" stroke="#ebebeb" transform="translate(996.479 412.182)">
                    <path d="M5.458 125.863v113.6c0 6.4 5.1 11.5 11.2 11.5h179.6c6.2 0 11.1-5.1 11.1-11.5v-113.6H5.458zM209.104 112.746H3.704c-2 0-3.7 1.7-3.7 3.8 0 2.1 1.7 3.8 3.7 3.8h205.4c2.1 0 3.7-1.7 3.7-3.8 0-2.1-1.6-3.8-3.7-3.8z" />
                    <path d="M5.458 119.626v5.3h201.9v-5.3H5.458z" />
                </g>
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1225.862 417.201h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1229.263 440.686h99.4v16.9h-99.4v-16.9z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1229.263 440.686)"
                >
                    <tspan
                        x={47.7}
                        y={14.4}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1229.263 421.638h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1229.263 421.638)"
                >
                    <tspan
                        x={18.7}
                        y={14.8}
                ...
                <text
                    ...
                    transform="translate(1048.741 219.85)"
                >
                    <tspan
                        x={37.9}
                        y={19.8}
                ...
                <path
                    ...
                    strokeWidth={2}
                    d="M1204.494 632.938h178.7M1382.264 632.938v285.8"
                />
                <path
                    fill="#ffc37c"
                    stroke="#868686"
                    d="M201.043 543.044c0-7.2 6-13.1 13.4-13.1s13.4 5.9 13.4 13.1c0 7.2-6 13.1-13.4 13.1s-13.4-5.9-13.4-13.1z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(201.043 529.944)"
                >
                    <tspan
                        x={6.4}
                        y={18.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M238.231 543.96h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(238.231 543.96)"
                >
                    <tspan
                        x={19.2}
                        y={15.1}
                ...
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1237.275 609.483h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1240.421 632.361h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1240.421 632.361)"
                >
                    <tspan
                        x={29.2}
                        y={15.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1240.421 613.313h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1240.421 613.313)"
                >
                    <tspan
                        x={29.7}
                        y={14.8}
                ...
                <path
                    ...
                    transform="translate(112.87 569.001)"
                />
                <path
                    fill="url(#r)"
                ...
                <path
                    ...
                    transform="translate(101.548 570.52)"
                />
                <path
                    fill="url(#t)"
                ...
                <path
                    ...
                    transform="matrix(0 1 1 0 146.51 514.812)"
                />
                <path
                    fill="url(#t)"
                ...
                <path
                    ...
                    transform="matrix(0 1 1 0 155.936 561.161)"
                />
                <path
                    fill="url(#t)"
                    d="M0 0h1.5v2.4H0V0z"
                    transform="matrix(0 1 1 0 147.59 561.064)"
                />
                <path
                    fill="url(#t)"
                    d="M0 0h1.5v2.4H0V0z"
                    transform="matrix(0 1 1 0 158.163 561.064)"
                />
                <path
                    fill="url(#t)"
                    d="M0 0h1.5v2.4H0V0z"
                    transform="matrix(0 1 1 0 168.735 561.064)"
                />
                <path
                    fill="url(#t)"
                    d="M0 0h1.5v2.4H0V0z"
                    transform="matrix(0 1 1 0 179.308 561.064)"
                />
                <path fill="#98bcdf" d="M180.032 524.82v29.8h2.4v-29.8h-2.4z" />
                <path fill="#6f9fce" d="M182.62 524.82v29.8h5.2v-29.8h-5.2z" />
                <path fill="#91b7dd" d="M186.813 524.82v29.8h1.9v-29.8h-1.9z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                ...
                <g fill="none" stroke="red" strokeWidth={2}>
                    <path d="m119.868 576.116 101.827 17.97M221.676 594.082l-101.826 17.97M119.868 612.048l101.827 17.97M221.676 630.014l-101.826 17.97M119.868 576.116h101.8M119.868 647.98h107.8" />
                </g>
                <path
                    fill="url(#w)"
                    stroke="#696969"
                    d="M0 0h57.4v66.8H0V0z"
                    transform="translate(1765.932 541.674)"
                />
                <path
                    fill="none"
                    stroke="#92d050"
                ...
                <path
                    ...
                    stroke="#00b0f0"
                    strokeWidth={5.333}
                    d="m1765.293 595.622 59.324-41.85"
                />
                <path
                    fill="url(#r)"
                    d="M0 6.4h112.8V0H0v6.4z"
                    transform="translate(489.355 123.152)"
                />
                <path
                    fill="url(#s)"
                    d="M0 1.6h112.8V0H0v1.6z"
                    transform="translate(489.356 127.933)"
                />
                <path
                    fill="url(#s)"
                    d="M0 1.8h112.8V0H0v1.8z"
                ...
                <path
                    ...
                    stroke="red"
                    strokeWidth={2}
                    d="m590.533 200.809-82.722-14.598M507.837 186.215l82.722-14.597M590.533 171.622l-82.722-14.598M507.837 157.028l82.722-14.598M590.533 200.809h-113M590.533 142.435h-109.1"
                />
                <path
                    fill="url(#r)"
                    d="M0 6.4h112.8V0H0v6.4z"
                    transform="translate(491.247 216.626)"
                />
                <path
                    fill="url(#s)"
                    d="M0 1.6h112.8V0H0v1.6z"
                    transform="translate(491.247 221.406)"
                />
                <path
                    fill="url(#s)"
                    d="M0 1.8h112.8V0H0v1.8z"
                ...
                <path
                    ...
                    stroke="red"
                    strokeWidth={2}
                    d="m591.418 291.631-82.722-14.597M508.722 277.038l82.722-14.598M591.418 262.445l-82.722-14.599M508.722 247.85l82.722-14.597M591.418 291.631h-107.2M591.418 233.257h-112M477.494 200.809h-60.5M417.922 200.809v32.1"
                />
                <g stroke="red">
                ...
                <path
                    ...
                    transform="rotate(-90 359.356 -81.29)"
                />
                <path
                    fill="url(#n)"
                ...
                />
                <path fill="#3e3938" d="M449.008 273.765v-15.7h6.6v15.7h-6.6z" />
                <path
                    fill="url(#o)"
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M163.787 258.675h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(163.787 258.675)"
                >
                    <tspan
                        x={26.7}
                        y={14.8}
                ...
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M160.385 254.238h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="none"
                    stroke="#236ea1"
                ...
                <path
                    ...
                    stroke="red"
                    strokeWidth={2}
                    d="M219.467 576.46h139M358.468 577.406v-435"
                />
                <g stroke="red">
                ...
                />
                <g stroke="red">
                    <path fill="none" strokeWidth={2} d="M471.003 302.24h-11.4" />
                    <path
                        fill="red"
                        strokeLinecap="round"
                        d="m471.003 298.04 8.5 4.2-8.5 4.2v-8.4"
                    />
                </g>
                <path fill="none" stroke="red" strokeWidth={2} d="M459.646 301.295v25.5" />
                <path
                    fill="red"
                    stroke="red"
                    d="M456.09 358.22v-11.5h-4.2l8.4-17.1 8.4 17.1h-4.2v11.5h-8.4z"
                />
                <path fill="#fff" d="M416.28 358.2h88v28.6h-88v-28.6z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(416.28 358.2)"
                >
                    <tspan
                        x={25}
                        y={20.3}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1243.75 193.117h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1243.75 193.117)"
                >
                    <tspan
                        x={33.7}
                        y={14.8}
                ...
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1240.424 189.335h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1243.75 212.166h99.4v16.9h-99.4v-16.9z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1243.75 212.166)"
                >
                    <tspan
                        x={47.7}
                        y={14.4}
                ...
                <path
                    ...
                    transform="translate(1282.223 256.279)"
                />
                <path
                    fill="url(#A)"
                    d="M1.7 0v3c0 .2-.2.3-.3.3H.3C.1 3.3 0 3.2 0 3V0h1.7z"
                    transform="translate(1283.851 262.33)"
                />
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                    transform="translate(1283.085 262.363)"
                />
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                    transform="translate(1283.085 264.03)"
                />
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                ...
                <path
                    fill="url(#z)"
                    d="M1.1 1.7C1.1 1 1.7.4 2.5.4c.7 0 1.3.6 1.3 1.3 0 .7-.6 1.3-1.3 1.3-.8 0-1.4-.6-1.4-1.3zM.7 0S0 0 0 .7v2.1s0 .6.7.6c.6.1.8.9.8.9v1.8h1.9V4.3s.1-.9.8-.9c.7 0 .7-.6.7-.6V.7c0-.6-.7-.7-.7-.7H.7z"
                    transform="translate(1304.303 256.279)"
                />
                <path
                    fill="url(#A)"
                    d="M1.7 0v3c0 .2-.2.3-.3.3H.3C.1 3.3 0 3.2 0 3V0h1.7z"
                    transform="translate(1305.93 262.33)"
                />
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                ...
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                    transform="translate(1307.544 262.363)"
                />
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                    transform="translate(1307.544 264.03)"
                />
                <path
                    fill="url(#x)"
                    d="M.5 0h.4c.3 0 .5.2.5.5V10c0 .3-.2.5-.5.5H.5c-.3 0-.5-.2-.5-.5V.5C0 .2.2 0 .5 0z"
                    transform="translate(1313.257 256.161)"
                />
                <path
                    fill="url(#x)"
                    d="M.5 0h.4c.3 0 .5.2.5.5V10c0 .3-.2.5-.5.5H.5c-.3 0-.5-.2-.5-.5V.5C0 .2.2 0 .5 0z"
                    transform="translate(1276.605 256.215)"
                />
                <path
                    fill="url(#y)"
                    d="M0 0h7.5v1.3H0V0z"
                    transform="translate(1292.05 245.442)"
                />
                <path
                    fill="url(#B)"
                    d="M0 0h15.3v6.7H0V0z"
                    transform="translate(1288.133 238.853)"
                />
                <path
                    fill="url(#C)"
                    d="M0 1.6h15.3V0H0v1.6z"
                    transform="translate(1288.133 237.362)"
                />
                <path
                    fill="#757263"
                    d="M1296.71 242.191c0-1 .9-1.9 1.9-1.9 1.1 0 2 .9 2 1.9 0 1.1-.9 1.9-2 1.9-1 0-1.9-.8-1.9-1.9z"
                />
                <path
                    fill="#edebdf"
                    d="M1296.856 242.236c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8c0 .9-.8 1.7-1.8 1.7s-1.8-.8-1.8-1.7z"
                />
                <path
                    fill="#635d4f"
                    d="M1297.139 242.216c0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5-.7 1.5-1.5 1.5-1.5-.7-1.5-1.5z"
                />
                <path
                    stroke="#000"
                    d="M1297.393 242.168c0-.6.6-1.2 1.2-1.2.7 0 1.3.6 1.3 1.2 0 .7-.6 1.3-1.3 1.3-.6 0-1.2-.6-1.2-1.3z"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.22}
                    d="M1297.722 241.37c.386-.46 1.231-.533 1.69-.148.537.45-.462.396-.912.932s-.158 1.433-.694.983c-.46-.385-.534-1.23-.084-1.767z"
                />
                <path
                    fill="#757263"
                    d="M1291.253 242.192c0-1 .9-1.9 1.9-1.9 1.1 0 2 .9 2 1.9 0 1.1-.9 1.9-2 1.9-1 0-1.9-.8-1.9-1.9z"
                />
                <path
                    fill="#edebdf"
                    d="M1291.398 242.237c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8c0 .9-.8 1.7-1.8 1.7s-1.8-.8-1.8-1.7z"
                />
                <path
                    fill="#635d4f"
                    d="M1291.68 242.217c0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5-.7 1.5-1.5 1.5-1.5-.7-1.5-1.5z"
                />
                <path
                    stroke="#000"
                    d="M1291.935 242.169c0-.6.6-1.2 1.2-1.2.7 0 1.3.6 1.3 1.2 0 .7-.6 1.3-1.3 1.3-.6 0-1.2-.6-1.2-1.3z"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.22}
                    d="M1292.264 241.371c.386-.46 1.231-.533 1.691-.148.536.45-.462.396-.912.932s-.159 1.433-.695.983c-.46-.385-.534-1.23-.084-1.767z"
                />
                <path
                    fill="url(#D)"
                ...
                <path
                    fill="url(#F)"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 216.62 766.846)"
                />
                <path
                    fill="url(#G)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 -1 -1 0 216.937 775.37)"
                />
                <path
                    fill="url(#H)"
                ...
                <path
                    ...
                    transform="translate(225.924 777.756)"
                />
                <path
                    fill="url(#I)"
                    stroke="#595959"
                    d="M3.7 0h7l3.7 5.2H0L3.7 0z"
                    transform="translate(226.844 772.711)"
                />
                <path
                    fill="url(#F)"
                    stroke="#595959"
                ...
                <path
                    ...
                    transform="matrix(0 -1 -1 0 243.222 774.868)"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.27}
                ...
                <path
                    ...
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M234.104 762.89c1.5 0 2.7 1.2 2.7 2.8 0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.8-1.2-2.8-2.7 0-1.6 1.3-2.8 2.8-2.8z"
                />
                <path
                    fill="url(#K)"
                    stroke="#595959"
                    ...
                    transform="rotate(90 -263.645 499.848)"
                />
                <path
                    fill="url(#G)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 1 1 0 250.941 754.974)"
                />
                <path
                    fill="url(#H)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                ...
                <path
                    fill="#fff"
                    fillOpacity={0.35}
                    d="M252.003 755.338v9.3c0 .1.1.2.1.2.1 0 .2-.1.2-.2v-9.3c0-.1-.1-.2-.2-.2 0 0-.1.1-.1.2z"
                />
                <path
                    fill="url(#L)"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 215.674 828.631)"
                />
                <path
                    fill="url(#M)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                ...
                <path
                    fill="#ffc000"
                    d="M173.133 768.037h41.9v4.7h-41.9v-4.7zM197.575 830.445h17.5v4.7h-17.5v-4.7z"
                />
                ...
                <path
                    ...
                    stroke="#ffc000"
                    strokeWidth={4}
                    d="M249.637 821.878h99.3M348.923 821.878v-64.3M251.617 758.96h212.8M199.61 832.716v-64.3M463.428 759.905v-230.7"
                />
                <g stroke="#ffc000">
                ...
                <path
                    ...
                    transform="rotate(180 273.41 303.482)"
                />
                <path
                    fill="#b4b5b5"
                    d="M545.6 605.94h-22.9c-.1 0-.3-.1-.3-.3v-15.9c0-.2.2-.3.3-.3h22.9c.2 0 .3.1.3.3v15.9c0 .2-.1.3-.3.3z"
                />
                ...
                <path
                    fill="url(#R)"
                    d="M0 0h1.1v3.4H0V0z"
                    transform="rotate(180 273.962 296.865)"
                />
                <path
                    fill="url(#R)"
                ...
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M521.013 624.686h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M524.16 647.565h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(524.16 647.565)"
                >
                    <tspan
                        x={47.7}
                        y={15.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M524.16 628.517h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(524.16 628.517)"
                >
                    <tspan
                        x={31.2}
                        y={14.8}
                ...
                <text
                    ...
                    transform="translate(567.017 512.135)"
                >
                    <tspan
                        x={20.5}
                        y={19.8}
                ...
                <path
                    ...
                    transform="translate(597.938 758.036)"
                />
                <path
                    fill="url(#X)"
                    d="M0 4.4h53.4V0H0v4.4z"
                ...
                <path
                    fill="url(#X)"
                    d="M5.2 0H59c2.8 0 5.2 1.9 5.2 4.3v50.4c0 2.3-2.4 4.3-5.2 4.3H5.2C2.3 59 0 57 0 54.7V4.3C0 1.9 2.3 0 5.2 0z"
                    transform="translate(709.59 758.036)"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                ...
                <path
                    fill="#92d050"
                    d="M674.767 688.547c0-7.1 5.7-12.8 12.8-12.8 7 0 12.7 5.7 12.7 12.8 0 7-5.7 12.7-12.7 12.7-7.1 0-12.8-5.7-12.8-12.7z"
                />
                <path
                    fill="none"
                    stroke="#ffc000"
                ...
                <path
                    fill="url(#x)"
                    d="M0 0h10.9v8.2H0V0z"
                    transform="rotate(-90 797.92 115.032)"
                />
                <path
                    fill="url(#x)"
                    d="M0 0h10.9v8.2H0V0z"
                ...
                <path
                    fill="url(#x)"
                    d="M.5 0h1.6c.3 0 .5.2.5.5v12c0 .3-.2.5-.5.5H.5c-.3 0-.5-.2-.5-.5V.5C0 .2.2 0 .5 0z"
                    transform="rotate(-90 794.022 113.469)"
                />
                <path
                    fill="url(#z)"
                    d="M1.1 1.7C1.1 1 1.7.4 2.5.4c.7 0 1.3.6 1.3 1.3 0 .7-.6 1.3-1.3 1.3-.8 0-1.4-.6-1.4-1.3zM.7 0S0 0 0 .7v2.1s0 .6.7.6c.6.1.8.9.8.9v1.8h1.9V4.3s.1-.9.8-.9c.7 0 .7-.6.7-.6V.7c0-.6-.7-.7-.7-.7H.7z"
                ...
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                    transform="rotate(-90 797.505 107.89)"
                />
                <path
                    fill="url(#x)"
                    d="M.5 0h1.6c.3 0 .5.2.5.5v12c0 .3-.2.5-.5.5H.5c-.3 0-.5-.2-.5-.5V.5C0 .2.2 0 .5 0z"
                ...
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                    transform="rotate(-90 785.631 97.684)"
                />
                <path
                    fill="url(#x)"
                    d="M.2 0h.4c.1 0 .2.1.2.2v1c0 .1-.1.2-.2.2H.2c-.1 0-.2-.1-.2-.2v-1C0 .1.1 0 .2 0z"
                ...
                <path
                    fill="url(#x)"
                    d="M.5 0h.4c.3 0 .5.2.5.5V10c0 .3-.2.5-.5.5H.5c-.3 0-.5-.2-.5-.5V.5C0 .2.2 0 .5 0z"
                    transform="rotate(-90 779.674 97.928)"
                />
                <path
                    fill="url(#x)"
                    d="M.5 0h.4c.3 0 .5.2.5.5V10c0 .3-.2.5-.5.5H.5c-.3 0-.5-.2-.5-.5V.5C0 .2.2 0 .5 0z"
                    transform="rotate(-90 798.027 116.227)"
                />
                <path
                    fill="url(#y)"
                    d="M0 0h7.5v1.3H0V0z"
                    transform="rotate(-90 784.918 113.89)"
                />
                <path
                    fill="url(#B)"
                    d="M0 0h15.3v6.7H0V0z"
                ...
                <path
                    fill="#edebdf"
                    d="M667.82 894.003c-1 0-1.8-.8-1.8-1.8s.8-1.8 1.8-1.8c.9 0 1.7.8 1.7 1.8s-.8 1.8-1.7 1.8z"
                />
                <path
                    fill="#635d4f"
                ...
                <path
                    stroke="#000"
                    d="M667.753 893.466c-.6 0-1.2-.6-1.2-1.2 0-.7.6-1.3 1.2-1.3.7 0 1.3.6 1.3 1.3 0 .6-.6 1.2-1.3 1.2z"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.22}
                    d="M666.955 893.137c-.46-.386-.534-1.231-.148-1.69.45-.537.395.461.932.911.536.45 1.433.159.983.695-.386.46-1.23.534-1.767.084z"
                />
                <path
                    fill="#757263"
                    d="M667.777 899.606c-1 0-1.9-.9-1.9-1.9 0-1.1.9-2 1.9-2 1.1 0 1.9.9 1.9 2 0 1-.8 1.9-1.9 1.9z"
                />
                <path
                    fill="#edebdf"
                ...
                <path
                    fill="#635d4f"
                    d="M667.802 899.178c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5z"
                />
                <path
                    stroke="#000"
                    d="M667.754 898.924c-.6 0-1.2-.6-1.2-1.2 0-.7.6-1.3 1.2-1.3.7 0 1.3.6 1.3 1.3 0 .6-.6 1.2-1.3 1.2z"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.22}
                    d="M666.956 898.594c-.46-.385-.534-1.23-.148-1.69.45-.536.395.462.932.912.536.45 1.433.159.983.695-.386.46-1.23.533-1.767.083z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                ...
                <path
                    fill="url(#l)"
                    d="M0 0h3.2v8.2H0V0z"
                    transform="rotate(90 31.673 665.84)"
                />
                <path
                    fill="url(#m)"
                    d="M.3 0h15.1c.2 0 .3.1.3.2v.3c0 .1-.1.2-.3.2H.3C.1.7 0 .6 0 .5V.2C0 .1.1 0 .3 0z"
                ...
                <path
                    fill="url(#o)"
                    d="M.1 0h15.5s.1 0 .1.1v1.2c0 .1-.1.1-.1.1H.1c-.1 0-.1 0-.1-.1V.1C0 0 0 0 .1 0z"
                    transform="rotate(90 35.845 663.801)"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M724.471 618.437h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(724.471 618.437)"
                >
                    <tspan
                        x={26.7}
                        y={14.8}
                ...
                <path
                    ...
                    strokeDasharray="4,10"
                    strokeWidth={2}
                    d="M548.531 598.21h157M705.498 598.21v29.3"
                />
                <path
                    fill="#ffc000"
                    stroke="#ffc000"
                ...
                <path
                    fill="url(#G)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 -1 -1 0 1142.545 958.991)"
                />
                <path
                    fill="url(#H)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                ...
                <path
                    fill="url(#I)"
                    d="M0 0h16.2v2.2H0V0z"
                    transform="translate(1151.532 961.377)"
                />
                <path
                    fill="url(#I)"
                    stroke="#595959"
                    d="M3.7 0h7l3.7 5.2H0L3.7 0z"
                    transform="translate(1152.452 956.333)"
                />
                <path
                    fill="url(#F)"
                    stroke="#595959"
                ...
                <path
                    ...
                    strokeWidth={0.25}
                    d="M0 9.2C0 4.1 4.1 0 9.2 0s9.2 4.1 9.2 9.2c0 5-4.1 9.1-9.2 9.1S0 14.2 0 9.2z"
                    transform="matrix(0 -1 -1 0 1168.83 958.489)"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.27}
                ...
                <path
                    ...
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M1159.712 946.511c1.5 0 2.7 1.2 2.7 2.8 0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.8-1.2-2.8-2.7 0-1.6 1.3-2.8 2.8-2.8z"
                />
                <path
                    fill="url(#K)"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M0 2.1C0 .9 1 0 2.1 0c1.2 0 2.2.9 2.2 2.1 0 1.2-1 2.2-2.2 2.2C1 4.3 0 3.3 0 2.1z"
                    transform="rotate(90 107.348 1054.463)"
                />
                <path
                    fill="url(#G)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 1 1 0 1176.55 938.596)"
                />
                <path
                    fill="url(#H)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                    transform="rotate(90 119.182 1057.816)"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.35}
                ...
                <path
                    fill="url(#L)"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 1141.282 1012.255)"
                />
                <path
                    fill="url(#M)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 -1 -1 0 1141.6 1020.778)"
                />
                <path
                    fill="url(#N)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                    transform="rotate(-90 1080.946 -60.205)"
                />
                <path
                    fill="#92d050"
                    d="M1140.538 1020.415v-9.3c0-.1-.1-.2-.1-.2-.1 0-.2.1-.2.2v9.3c0 .1.1.2.2.2 0 0 .1-.1.1-.2z"
                />
                <path
                    fill="url(#O)"
                    d="M0 0h16.2v2.2H0V0z"
                    transform="translate(1150.586 1023.165)"
                />
                <path
                    fill="url(#O)"
                    stroke="#595959"
                    d="M3.7 0h7l3.7 5.2H0L3.7 0z"
                    transform="translate(1151.506 1018.12)"
                />
                <path
                    fill="url(#L)"
                    stroke="#595959"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 1159.199 1001.884)"
                />
                <path
                    fill="url(#P)"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M0 9.2C0 4.1 4.1 0 9.2 0s9.2 4.1 9.2 9.2c0 5-4.1 9.1-9.2 9.1S0 14.2 0 9.2z"
                    transform="matrix(0 -1 -1 0 1167.885 1020.276)"
                />
                <path
                    fill="#92d050"
                    d="M1158.74 1018.72c4.2 0 7.6-3.4 7.6-7.7 0-4.2-3.4-7.6-7.6-7.6-4.2 0-7.6 3.4-7.6 7.6 0 4.3 3.4 7.7 7.6 7.7z"
                />
                <path
                    fill="#92d050"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M1158.766 1008.298c1.5 0 2.7 1.2 2.7 2.8 0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.8-1.2-2.8-2.7 0-1.6 1.3-2.8 2.8-2.8z"
                />
                <path
                    fill="url(#Q)"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M0 2.1C0 .9 1 0 2.1 0c1.2 0 2.2.9 2.2 2.1 0 1.2-1 2.2-2.2 2.2C1 4.3 0 3.3 0 2.1z"
                    transform="rotate(90 75.981 1084.884)"
                />
                <path
                    fill="url(#M)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 1 1 0 1175.604 1000.383)"
                />
                <path
                    fill="url(#N)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                    transform="rotate(90 87.815 1088.237)"
                />
                <path
                    fill="#92d050"
                    d="M1176.665 1000.747v9.3c0 .1.1.2.1.2.1 0 .2-.1.2-.2v-9.3c0-.1-.1-.2-.2-.2 0 0-.1.1-.1.2z"
                />
                <path
                    fill="#ffc000"
                    d="M1098.735 951.661h41.9v4.7h-41.9v-4.7zM1123.183 1014.07h17.5v4.7h-17.5v-4.7z"
                />
                <path fill="#fff" d="M1134.54 973.915h77.5v18.8h-77.5v-18.8z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1134.54 973.915)"
                >
                    <tspan
                        x={18.8}
                        y={15.4}
                ...
                <path
                    ...
                    stroke="#ffc000"
                    strokeWidth={4}
                    d="M1175.237 1005.503h99.3M1274.524 1007.394v-64.3M1124.27 1016.34v-61.6"
                />
                <path fill="#fff" d="M1133.594 910.43h77.5v18.8h-77.5v-18.8z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1133.594 910.43)"
                >
                    <tspan
                        x={18.8}
                        y={15.4}
                ...
                <path
                    ...
                    stroke="#ffc000"
                    strokeWidth={4}
                    d="m1098.862 664.4-.123 292M1176.4 942.403h341.4"
                />
                <path
                    fill="#ffc000"
                    stroke="#ffc000"
                    d="M1523.872 938.067h11.5v-4.2l17.1 8.4-17.1 8.4v-4.2h-11.5v-8.4z"
                />
                <path fill="#fff" d="M1558.001 929.074h94.5v26.4h-94.5v-26.4z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1558.001 929.074)"
                >
                    <tspan
                        x={20.2}
                        y={19.2}
                ...
                <text
                    ...
                    transform="translate(1405.081 660.184)"
                >
                    <tspan
                        x={21}
                        y={19.8}
                ...
                <g stroke="#92d050">
                    <path fill="none" strokeWidth={4} d="M1437.382 358.39v248.6" />
                    <path
                        fill="#92d050"
                        strokeLinecap="round"
                        d="m1443.382 606.99-6 12-6-12h12"
                    />
                </g>
                <path
                    fill="url(#R)"
                    d="M0 0h41.4v13.4H0V0z"
                    transform="translate(1361.879 934.428)"
                />
                <path
                    fill="url(#S)"
                    d="M.3 0H25c.2 0 .3.1.3.3v18c0 .1-.1.2-.3.2H.3c-.2 0-.3-.1-.3-.2V.3C0 .1.1 0 .3 0z"
                    transform="translate(1369.933 904.23)"
                />
                <path
                    fill="#b4b5b5"
                    d="M1371.153 905.255h22.9c.1 0 .3.1.3.3v15.9c0 .2-.2.3-.3.3h-22.9c-.2 0-.3-.1-.3-.3v-15.9c0-.2.1-.3.3-.3z"
                />
                <path fill="#92d050" d="M1371.585 906.102h22v14.8h-22v-14.8z" />
                <path
                    fill="url(#T)"
                    d="M0 0h6v12.1s-.1.8-3 .8-3-.8-3-.8V0z"
                    transform="translate(1379.608 922.674)"
                />
                <path
                    fill="url(#R)"
                    d="M.6 0H2c.3 0 .5.2.5.5V19c0 .3-.2.5-.5.5H.6c-.4 0-.6-.2-.6-.5V.5C0 .2.2 0 .6 0z"
                    transform="translate(1364.999 931.391)"
                />
                <path
                    fill="url(#R)"
                    d="M.6 0H2c.3 0 .5.2.5.5V19c0 .3-.2.5-.5.5H.6c-.4 0-.6-.2-.6-.5V.5C0 .2.2 0 .6 0z"
                    transform="translate(1397.636 931.391)"
                />
                <path
                    fill="url(#U)"
                    d="M0 0h.6v13.4H0V0z"
                    transform="translate(1367.538 934.444)"
                />
                <path
                    fill="url(#U)"
                    d="M0 0h.6v13.4H0V0z"
                    transform="translate(1397.056 934.444)"
                />
                <path
                    fill="url(#V)"
                    d="M0 0h27.5v3.4H0V0z"
                ...
                <path
                    fill="url(#T)"
                    d="M0 0h2.9v1.4H0V0z"
                    transform="translate(1372.663 902.85)"
                />
                <path
                    fill="url(#T)"
                    d="M0 0h1.5v1.4H0V0z"
                    transform="translate(1373.383 901.528)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h1.1v3.4H0V0z"
                ...
                <path
                    fill="url(#R)"
                    d="M0 0h11.5v1.2H0V0z"
                    transform="translate(1357.465 918.596)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h11.2v1.2H0V0z"
                    transform="matrix(0 -1 -1 0 1357.013 931.537)"
                />
                <path
                    fill="url(#W)"
                    d="M0 0s.9 0 1.3.5.3 1.3.3 1.3H.5s0-.5-.5-.7V0z"
                    transform="matrix(-1 0 0 1 1357.468 918.596)"
                />
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1329.328 962.176h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1332.474 985.055h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1332.474 985.055)"
                >
                    <tspan
                        x={47.7}
                        y={15.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1332.474 966.007h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1332.474 966.007)"
                >
                    <tspan
                        x={31.2}
                        y={14.8}
                ...
                <path
                    ...
                    strokeDasharray="4,10"
                    strokeWidth={2}
                    d="m1382.463 860.469.944 46.29"
                />
                <path
                    fill="url(#F)"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 1489.91 792.725)"
                />
                <path
                    fill="url(#G)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 -1 -1 0 1490.228 801.248)"
                />
                <path
                    fill="url(#H)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                    transform="rotate(-90 1145.495 -344.285)"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.35}
                    d="M1489.166 800.885v-9.3c0-.1-.1-.2-.1-.2-.1 0-.2.1-.2.2v9.3c0 .1.1.2.2.2 0 0 .1-.1.1-.2z"
                />
                <path
                    fill="url(#I)"
                    d="M0 0h16.2v2.2H0V0z"
                    transform="translate(1499.214 803.635)"
                />
                <path
                    fill="url(#I)"
                    stroke="#595959"
                    d="M3.7 0h7l3.7 5.2H0L3.7 0z"
                    transform="translate(1500.135 798.59)"
                />
                <path
                    fill="url(#F)"
                    stroke="#595959"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 1507.827 782.354)"
                />
                <path
                    fill="url(#J)"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M0 9.2C0 4.1 4.1 0 9.2 0s9.2 4.1 9.2 9.2c0 5-4.1 9.1-9.2 9.1S0 14.2 0 9.2z"
                    transform="matrix(0 -1 -1 0 1516.513 800.746)"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.27}
                    d="M1507.368 799.19c4.2 0 7.6-3.4 7.6-7.7 0-4.2-3.4-7.6-7.6-7.6-4.2 0-7.6 3.4-7.6 7.6 0 4.3 3.4 7.7 7.6 7.7z"
                />
                <path
                    fill="#9da6b0"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M1507.394 788.768c1.5 0 2.7 1.2 2.7 2.8 0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.8-1.2-2.8-2.7 0-1.6 1.3-2.8 2.8-2.8z"
                />
                <path
                    fill="url(#K)"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M0 2.1C0 .9 1 0 2.1 0c1.2 0 2.2.9 2.2 2.1 0 1.2-1 2.2-2.2 2.2C1 4.3 0 3.3 0 2.1z"
                    transform="rotate(90 360.06 1149.433)"
                />
                <path
                    fill="url(#G)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 1 1 0 1524.232 780.853)"
                />
                <path
                    fill="url(#H)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                    transform="rotate(90 371.894 1152.786)"
                />
                <path
                    fill="#fff"
                    fillOpacity={0.35}
                    d="M1525.293 781.217v9.3c0 .1.1.2.1.2.1 0 .2-.1.2-.2v-9.3c0-.1-.1-.2-.2-.2 0 0-.1.1-.1.2z"
                />
                <path
                    fill="url(#L)"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 1488.965 854.51)"
                />
                <path
                    fill="url(#M)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 -1 -1 0 1489.282 863.033)"
                />
                <path
                    fill="url(#N)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                    transform="rotate(-90 1175.914 -312.92)"
                />
                <path
                    fill="#92d050"
                    d="M1488.22 862.67v-9.3c0-.1-.1-.2-.1-.2-.1 0-.2.1-.2.2v9.3c0 .1.1.2.2.2 0 0 .1-.1.1-.2z"
                />
                <path
                    fill="url(#O)"
                    d="M0 0h16.2v2.2H0V0z"
                    transform="translate(1498.269 865.42)"
                />
                <path
                    fill="url(#O)"
                    stroke="#595959"
                    d="M3.7 0h7l3.7 5.2H0L3.7 0z"
                    transform="translate(1499.19 860.375)"
                />
                <path
                    fill="url(#L)"
                    stroke="#595959"
                    d="M0 0h7v16.5H0V0z"
                    transform="matrix(0 1 1 0 1506.881 844.139)"
                />
                <path
                    fill="url(#P)"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M0 9.2C0 4.1 4.1 0 9.2 0s9.2 4.1 9.2 9.2c0 5-4.1 9.1-9.2 9.1S0 14.2 0 9.2z"
                    transform="matrix(0 -1 -1 0 1515.567 862.53)"
                />
                <path
                    fill="#92d050"
                    d="M1506.422 860.974c4.2 0 7.6-3.4 7.6-7.7 0-4.2-3.4-7.6-7.6-7.6-4.2 0-7.6 3.4-7.6 7.6 0 4.3 3.4 7.7 7.6 7.7z"
                />
                <path
                    fill="#92d050"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M1506.449 850.553c1.5 0 2.7 1.2 2.7 2.8 0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.8-1.2-2.8-2.7 0-1.6 1.3-2.8 2.8-2.8z"
                />
                <path
                    fill="url(#Q)"
                    stroke="#595959"
                    strokeWidth={0.25}
                    d="M0 2.1C0 .9 1 0 2.1 0c1.2 0 2.2.9 2.2 2.1 0 1.2-1 2.2-2.2 2.2C1 4.3 0 3.3 0 2.1z"
                    transform="rotate(90 328.696 1179.852)"
                />
                <path
                    fill="url(#M)"
                    d="M.3 0h9.4c.2 0 .3.3.3.7 0 .4-.1.7-.3.7H.3c-.2 0-.3-.3-.3-.7C0 .3.1 0 .3 0z"
                    transform="matrix(0 1 1 0 1523.286 842.638)"
                />
                <path
                    fill="url(#N)"
                    d="M9.9 0c0 .2-.1.4-.3.4H.3C.1.4 0 .2 0 0h9.9z"
                    transform="rotate(90 340.53 1183.205)"
                />
                <path
                    fill="#92d050"
                    d="M1524.348 843.001v9.3c0 .1.1.2.1.2.1 0 .2-.1.2-.2v-9.3c0-.1-.1-.2-.2-.2 0 0-.1.1-.1.2z"
                />
                <path
                    fill="#92d050"
                    stroke="#92d050"
                    d="M1445.889 793.916h42.5v4.7h-42.5v-4.7zM1470.865 857.27h17.5v4.7h-17.5v-4.7z"
                />
                <path fill="#fff" d="M1482.222 816.17h77.5v18.8h-77.5v-18.8z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1482.222 816.17)"
                >
                    <tspan
                        x={18.8}
                        y={15.4}
                ...
                <path
                    ...
                    stroke="#92d050"
                    strokeWidth={4}
                    d="M1522.92 847.757h84.7M1606.132 849.648v-294.9M1471.953 862.028v-65.1"
                />
                <path fill="#fff" d="M1481.276 752.683h77.5v18.8h-77.5v-18.8z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1481.276 752.683)"
                >
                    <tspan
                        x={18.8}
                        y={15.4}
                ...
                <path
                    ...
                    stroke="#92d050"
                    strokeWidth={4}
                    d="M1445.893 798.674v-78.5"
                />
                <path
                    fill="#92d050"
                    stroke="#92d050"
                    d="M1525.643 783.7h79.1v4.7h-79.1v-4.7z"
                />
                <path
                    fill="none"
                    stroke="#92d050"
                    strokeWidth={4}
                    d="M1767.392 556.604h-159.8M1607.588 722.081h56.7M1662.432 722.081v57.7"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h41.4v13.4H0V0z"
                    transform="translate(1616.497 717.184)"
                />
                <path
                    fill="url(#S)"
                    d="M.3 0H25c.2 0 .3.1.3.3v18c0 .1-.1.2-.3.2H.3c-.2 0-.3-.1-.3-.2V.3C0 .1.1 0 .3 0z"
                    transform="translate(1624.55 686.986)"
                />
                <path
                    fill="#b4b5b5"
                    d="M1625.772 688.01h22.9c.1 0 .3.1.3.3v15.9c0 .2-.2.3-.3.3h-22.9c-.2 0-.3-.1-.3-.3v-15.9c0-.2.1-.3.3-.3z"
                />
                <path fill="#92d050" d="M1626.203 688.857h22v14.8h-22v-14.8z" />
                <path
                    fill="url(#T)"
                    d="M0 0h6v12.1s-.1.8-3 .8-3-.8-3-.8V0z"
                    transform="translate(1634.226 705.429)"
                />
                <path
                    fill="url(#R)"
                    d="M.6 0H2c.3 0 .5.2.5.5V19c0 .3-.2.5-.5.5H.6c-.4 0-.6-.2-.6-.5V.5C0 .2.2 0 .6 0z"
                    transform="translate(1619.617 714.147)"
                />
                <path
                    fill="url(#R)"
                    d="M.6 0H2c.3 0 .5.2.5.5V19c0 .3-.2.5-.5.5H.6c-.4 0-.6-.2-.6-.5V.5C0 .2.2 0 .6 0z"
                    transform="translate(1652.254 714.147)"
                />
                <path
                    fill="url(#U)"
                    d="M0 0h.6v13.4H0V0z"
                    transform="translate(1622.156 717.2)"
                />
                <path
                    fill="url(#U)"
                    d="M0 0h.6v13.4H0V0z"
                    transform="translate(1651.675 717.2)"
                />
                <path
                    fill="url(#V)"
                    d="M0 0h27.5v3.4H0V0z"
                    transform="translate(1623.447 694.54)"
                />
                <path
                    fill="url(#T)"
                    d="M0 0h2.9v1.4H0V0z"
                    transform="translate(1627.282 685.605)"
                />
                <path
                    fill="url(#T)"
                    d="M0 0h1.5v1.4H0V0z"
                    transform="translate(1628 684.283)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h1.1v3.4H0V0z"
                    transform="translate(1623.447 700.22)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h11.5v1.2H0V0z"
                    transform="translate(1612.083 701.351)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h11.2v1.2H0V0z"
                    transform="matrix(0 -1 -1 0 1611.63 714.292)"
                />
                <path
                    fill="url(#W)"
                    d="M0 0s.9 0 1.3.5.3 1.3.3 1.3H.5s0-.5-.5-.7V0z"
                    transform="matrix(-1 0 0 1 1612.086 701.351)"
                />
                <path
                    fill="#92d050"
                    stroke="#92d050"
                ...
                />
                <path fill="#fff" d="M1631.514 817.585h60.2v26.4h-60.2v-26.4z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1631.514 817.585)"
                >
                    <tspan
                        x={12.1}
                        y={19.2}
                ...
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1613.306 634.252h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1616.453 657.132h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1616.453 657.132)"
                >
                    <tspan
                        x={47.7}
                        y={15.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1616.452 638.084h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1616.452 638.084)"
                >
                    <tspan
                        x={31.2}
                        y={14.8}
                ...
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1491.41 660.184h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1494.557 683.064h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1494.557 683.064)"
                >
                    <tspan
                        x={47.7}
                        y={15.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1494.557 664.015h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1494.557 664.015)"
                >
                    <tspan
                        x={29.7}
                        y={14.8}
                ...
                <path
                    ...
                    strokeDasharray="4,10"
                    strokeWidth={2}
                    d="M1548.016 662.51v-53.9M1548.016 608.61h116.3M1664.323 608.61v27.4"
                />
                <path
                    fill="none"
                    stroke="#236ea1"
                    strokeWidth={4}
                    d="M1765.293 595.622h-25.3M1741.861 595.622v130.2"
                />
                <path
                    fill="#00b0f0"
                    stroke="#00b0f0"
                    d="M1738.513 758.246v-11.5h-4.2l8.4-17.1 8.4 17.1h-4.2v11.5h-8.4z"
                />
                <path
                    fill="none"
                    stroke="#236ea1"
                    strokeWidth={4}
                    d="M1824.127 553.784h41.6M1865.733 552.821v173"
                />
                <path
                    fill="#00b0f0"
                    stroke="#00b0f0"
                    d="M1869.818 729.626v11.5h4.2l-8.4 17.1-8.4-17.1h4.2v-11.5h8.4z"
                />
                <path fill="#fff" d="M1756.045 762.062h80.4v36.6h-80.4v-36.6z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(1756.045 762.062)"
                >
                    <tspan
                        x={17.2}
                        y={14.3}
                ...
                <path
                    fill="url(#R)"
                    d="M0 0h41.4v13.4H0V0z"
                    transform="rotate(90 556.647 1192.253)"
                />
                <path
                    fill="url(#S)"
                    d="M.3 0H25c.2 0 .3.1.3.3v18c0 .1-.1.2-.3.2H.3c-.2 0-.3-.1-.3-.2V.3C0 .1.1 0 .3 0z"
                    transform="rotate(90 567.719 1211.379)"
                />
                <path
                    fill="#b4b5b5"
                    d="M1778.074 644.88v22.9c0 .1-.1.3-.3.3h-15.9c-.2 0-.3-.2-.3-.3v-22.9c0-.2.1-.3.3-.3h15.9c.2 0 .3.1.3.3z"
                />
                <path fill="#92d050" d="M1777.227 645.312v22h-14.8v-22h14.8z" />
                <path
                    fill="url(#T)"
                    d="M0 0h6v12.1s-.1.8-3 .8-3-.8-3-.8V0z"
                    transform="rotate(90 553.66 1206.995)"
                />
                <path
                    fill="url(#R)"
                    d="M.6 0H2c.3 0 .5.2.5.5V19c0 .3-.2.5-.5.5H.6c-.4 0-.6-.2-.6-.5V.5C0 .2.2 0 .6 0z"
                    transform="rotate(90 556.606 1195.332)"
                />
                <path
                    fill="url(#R)"
                    d="M.6 0H2c.3 0 .5.2.5.5V19c0 .3-.2.5-.5.5H.6c-.4 0-.6-.2-.6-.5V.5C0 .2.2 0 .6 0z"
                    transform="rotate(90 540.287 1211.65)"
                />
                <path
                    fill="url(#U)"
                    d="M0 0h.6v13.4H0V0z"
                    transform="rotate(90 553.81 1195.075)"
                />
                <path
                    fill="url(#U)"
                    d="M0 0h.6v13.4H0V0z"
                    transform="rotate(90 539.05 1209.834)"
                />
                <path
                    fill="url(#V)"
                    d="M0 0h27.5v3.4H0V0z"
                    transform="rotate(90 564.494 1207.05)"
                />
                <path
                    fill="url(#T)"
                    d="M0 0h2.9v1.4H0V0z"
                    transform="rotate(90 567.044 1213.435)"
                />
                <path
                    fill="url(#T)"
                    d="M0 0h1.5v1.4H0V0z"
                    transform="rotate(90 567.346 1214.456)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h1.1v3.4H0V0z"
                    transform="rotate(90 561.654 1204.21)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h11.5v1.2H0V0z"
                    transform="rotate(90 566.77 1197.962)"
                />
                <path
                    fill="url(#R)"
                    d="M0 0h11.2v1.2H0V0z"
                    transform="matrix(1 0 0 -1 1751.792 630.74)"
                />
                <path
                    fill="url(#W)"
                    d="M0 0s.9 0 1.3.5.3 1.3.3 1.3H.5s0-.5-.5-.7V0z"
                    transform="matrix(0 -1 -1 0 1764.733 631.196)"
                />
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1752.26 677.693h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1755.407 700.573h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1755.407 700.573)"
                >
                    <tspan
                        x={47.7}
                        y={15.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1755.406 681.525h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1755.406 681.525)"
                >
                    <tspan
                        x={31.2}
                        y={14.8}
                ...
                <path
                    ...
                    stroke="#92d050"
                    strokeWidth={4}
                    d="M1843.984 262.608v286.4M1822.709 594.895h23.2M1843.984 595.373v-37.7"
                />
                <path
                    fill="url(#k)"
                    d="M.2 0h15.1c.1 0 .3.1.3.2V12c0 .1-.2.2-.3.2H.2c-.1 0-.2-.1-.2-.2V.2C0 .1.1 0 .2 0z"
                ...
                <path
                    fill="url(#m)"
                    d="M.3 0h15.1c.2 0 .3.1.3.2v.3c0 .1-.1.2-.3.2H.3C.1.7 0 .6 0 .5V.2C0 .1.1 0 .3 0z"
                    transform="rotate(90 723.205 1144.835)"
                />
                <path
                    fill="url(#n)"
                    d="M.3 0h10.8c.1 0 .3.1.3.2v4c0 .1-.2.2-.3.2H.3c-.2 0-.3-.1-.3-.2v-4C0 .1.1 0 .3 0z"
                ...
                />
                <path fill="#3e3938" d="M1863.48 424.436v10.2h-3.6v-10.2h3.6z" />
                <path
                    fill="url(#o)"
                    d="M.1 0h15.5s.1 0 .1.1v1.2c0 .1-.1.1-.1.1H.1c-.1 0-.1 0-.1-.1V.1C0 0 0 0 .1 0z"
                    transform="rotate(90 717.636 1139.35)"
                />
                <path
                    fill="none"
                    stroke="#7e7e7e"
                    d="M1719.08 408.672h106.4v43.5h-106.4v-43.5z"
                />
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1722.226 431.552h99.4v18.2h-99.4v-18.2z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1722.226 431.552)"
                >
                    <tspan
                        x={47.7}
                        y={15.1}
                ...
                <path
                    fill="#fff"
                    stroke="#afafaf"
                    d="M1722.226 412.504h99.4v17.6h-99.4v-17.6z"
                />
                <text
                    xmlSpace="preserve"
                    style={{
                    ...
                    transform="translate(1722.226 412.504)"
                >
                    <tspan
                        x={26.7}
                        y={14.8}
                ...
                <path
                    ...
                    strokeDasharray="4,10"
                    strokeWidth={2}
                    d="M1868.57 429.895h18M1886.536 429.895v225M1886.536 654.945h-106.9"
                />
                <path
                    fill="none"
                    stroke="#ffc000"
                    strokeWidth={4}
                    d="M548.531 309.806v53.9M617.559 275.764h45.4M546.64 361.813h116.3M662.947 363.704v-89.8M662.947 320.207h46.3M709.28 318.316v175.9"
                />
                <g stroke="#ffc000">
                    <path fill="none" strokeWidth={4} d="M709.28 492.304h271.7" />
                    <path
                        fill="#ffc000"
                        strokeLinecap="round"
                        d="m980.98 486.304 12 6-12 6v-12"
                    />
                </g>
                <path
                    fill="none"
                    stroke="#236ea1"
                    strokeWidth={4}
                    d="M542.857 125.416v-20.8M540.966 104.613h218.4M757.506 104.613v367.8"
                />
                <g stroke="#236ea1">
                    <path fill="none" strokeWidth={4} d="M759.397 470.555h221.6" />
                    <path
                        fill="#236ea1"
                        strokeLinecap="round"
                        d="m980.997 464.555 12 6-12 6v-12"
                    />
                </g>
                <text
                    xmlSpace="preserve"
                ...
                <text
                    ...
                    transform="translate(1162.366 36.692)"
                >
                    <tspan
                        x={68.7}
                        y={58.6}
                ...
                />
                <path fill="#fff" d="M670.039 125.371h84.4v35.2h-84.4v-35.2z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(670.039 125.371)"
                >
                    <tspan
                        x={26.7}
                        y={13.6}
                ...
                <path fill="#fff" d="M27.48 745.291h137v50.2h-137v-50.2z" />
                <text
                    xmlSpace="preserve"
                    style={{
                        fill: "#000",
                    ...
                    transform="translate(27.48 745.291)"
                >
                    <tspan
                        x={21}
                        y={21.1}
                ...
                <text
                    ...
                    transform="translate(1741.79 538.837)"
                >
                    <tspan
                        x={37.9}
                        y={19.8}
