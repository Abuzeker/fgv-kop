...
const ChilledHMI = (props) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width='100%' height='100%' viewBox="1 1 1919 1079">
            ...
            <g stroke="#000">
                <path
                    fill={CT['C.T FAN 3'] === "True" ? "green" : "red"}
            ...
            <g stroke="#000">
                <path
                    fill={CT['C.T FAN 4'] === "True" ? "green" : "red"}
            ...
            <g stroke="#000">
                <path
                    fill={CT['C.T FAN 1'] === "True" ? "green" : "red"}
            ...
            <g stroke="#000">
                <path
                    fill={CT['C.T FAN 2'] === "True" ? "green" : "red"}
