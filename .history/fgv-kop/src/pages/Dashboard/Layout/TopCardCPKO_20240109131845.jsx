        ...
        <div style={{ marginTop: '5px', padding: '0 0px' }}>
            <Row gutter={[7, 10]}>
                ...
                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={10}>
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        <Row>
                            <Col span={6} style={{ borderRight: '1px solid white', paddingRight: '10px', paddingLeft: '10px' }}>
                                <span style={{ fontSize: '20px', color: 'white' }}>ToDate CPKO </span>
                ...
                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={5}>
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        <span style={{ fontSize: '20px', color: 'white' }}>RKO C/S</span>
                        <div>
                            <Row gutter={16} align={'middle'}>
                                <Col span={12}>
                                    <span style={{ fontSize: '25px', color: 'white' }}>{data['CPKO C/S']}</span>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'rkocstinybar'} data={props.cpkocs} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
