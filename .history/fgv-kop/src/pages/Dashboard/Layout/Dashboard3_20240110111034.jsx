    ...
    return (
        <Layout className="layout">
            ...
            >
                ...
                <PlantProcessingStatus ProductData={['CPO']} header={true}/>

                <div style={{ padding: '10px' }} ></div>

                <PlantProcessingStatus ProductData={['CPO','CPKO','Recyc.Ps']} header={false}/>
                <div style={{ padding: '10px' }} ></div>

                <PlantProcessingStatus ProductData={['CPO']} header={false}/>
                <div style={{ padding: '10px' }} ></div>
