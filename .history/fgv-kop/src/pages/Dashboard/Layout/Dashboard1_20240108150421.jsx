  ...
  return (
    <Layout className="layout">
      ...
      >
        ...
        <TopCPKOCard datatodate={highestCPO} datatoday={DataArray} cpolog={cpolog} cporcvLog={cporcvLog}
          cpocs={cpocs} cpoMA={cpoMA} cpoInfo={CPOCardInfo} cposhipment={CPOShipmentCompletion}></TopCPKOCard>
