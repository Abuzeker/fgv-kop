                ...
                <Layout className="layout">
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            <Button onClick={this.play} style={{ marginRight: '5px', fontSize: '15px' }} size='large' type='primary' shape="circle" icon={<PlayCircleOutlined />}>
                                {/* <PlayCircleOutlined/> */}
                            </Button>

                            <Button onClick={this.pause} style={{ marginRight: '10px', fontSize: '15px' }} size='large' type='primary' danger shape="circle" icon={<PauseCircleOutlined />}>
                                {/* <PauseCircleOutlined /> */}
                            </Button>
                        </div>
                    </Header>
