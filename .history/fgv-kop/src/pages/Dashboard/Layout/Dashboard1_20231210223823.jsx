      ...
      <Row gutter={[10, 30]} align={'middle'} >
        <Col span={12} xs={24} sm={24} md={24} xl={12} lg={12}>
          <Carousel fade={true} autoplay autoplaySpeed={50000} >
            ...
            <Card style={{ height: '100%', background: '#706f6f' }}>
              <BarchartWithColor data={extractedDataCPO} containername={'uti'} type={'Elektrik Usage (CPO)'}/>
            </Card>

            <Card style={{ height: '100%', background: '#706f6f' }}>
              <BarchartWithColor data={extractedDataCPO} containername={'uti'} type={'LNG Usage (CPO)'}/>
            </Card>
