    ...
    return (
        <Layout className="layout">
            ...
            >
                ...
                <span style={{ color: 'yellow', fontSize: '30px', fontWeight: 'bold' }}>Kuantan Oil Product (KOP) Production Status</span>
            </Header>
            ...
            >
                ...
                <PlantProcessingStatus ProductData={['Desmet600','CPO','CPKO']} header={false}/>
                <div style={{ padding: '10px' }} ></div>
