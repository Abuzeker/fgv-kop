        ...
        <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti6'} type={'Total Cost (CPO)'} range={[0.2, 0.3]} height={300} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable height={390} plant={'Refining'} />
        ...
        <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPKO} containername={'cpkouti6'} type={'Total Cost (CPKO)'} range={[0.2, 0.3]} height={300} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable height={390} plant={'Refining'} />
