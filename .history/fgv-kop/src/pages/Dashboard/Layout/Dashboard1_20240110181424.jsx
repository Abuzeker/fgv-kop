        ...
        <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
            ...
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti'} type={'Bleaching Earth Usage (CPO)'} range={[6.01, 7.01]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti2'} type={'Electric Usage (CPO)'} range={[14.01, 15.01]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti3'} type={'Phosphoric Usage (CPO)'} range={[0.55, 0.65]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti4'} type={'LNG Usage (CPO)'} range={[12.01, 12.99]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti5'} type={'Water Usage (CPO)'} range={[0.2, 0.3]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
        ...
        <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPKO} containername={'cpkouti'} type={'Bleaching Earth Usage (CPKO)'} range={[6, 7]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPKO} containername={'cpkouti2'} type={'Elektric Usage (CPKO)'} range={[14, 15]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPKO} containername={'cpkouti3'} type={'Phosphoric Usage (CPKO)'} range={[0.55, 0.65]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPKO} containername={'cpkouti4'} type={'LNG Usage (CPKO)'} range={[12.01, 12.99]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPKO} containername={'cpkouti5'} type={'Water Usage (CPKO)'} range={[0.2, 0.3]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
    ...
    <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
      <div>
        ...
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'crbdpouti'} type={'Bleaching Earth Usage (RBD PO)'} range={[6.01, 7.01]} />
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'crbdpoti2'} type={'Electric Usage (RBD PO)'} range={[14.01, 15.01]} />
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'rbdpoti3'} type={'Phosphoric Usage (RBD PO)'} range={[0.55, 0.65]} />
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'rbdpouti4'} type={'LNG Usage (RBD PO)'} range={[12.01, 12.99]} />
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'rbdpoti5'} type={'Water Usage (RBD PO)'} range={[0.2, 0.3]} />
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
  ...
  const request_log = async () => {
    ...
    const cpo_product_wuantity = await Request_dailydata_log(request_range_10,
      ['Today (CPO)', 'Todate (CPO)', 'Bleaching Earth Usage (CPO)',
        ...
        'LNG Usage (CPO) Remark', 'LNG Cost (CPO) Remark', 'Elektrik Usage (CPO) Remark', 'Elektrik Cost (CPO) Remark',
        ...
        'LNG Usage (CPKO) Remark', 'LNG Cost (CPKO) Remark', 'Elektrik Usage (CPKO) Remark', 'Elektrik Cost (CPKO) Remark',
    ...
    DataArray.forEach(element => {
      ...
      rbdporcvLog.push(element['RBD PO RCV'])
      rbdpocs.push(element['RBD PO C/S'])
      rbdpoMA.push(element['Today (RBD PO)'])
      rbdpoSC.push(element['Today (RBD PO)'])
              ...
              <Carousel fade={true} autoplay autoplaySpeed={30000}>
                ...
                <Divider orientation='left' style={{ color: 'white', borderColor: 'white' }}>Daily Report</Divider>
                  ...
                  <Row gutter={[10, 10]}>
                    ...
                    <Col span={10} xs={24} sm={24} md={24} lg={24} xl={10}>
                      <Card style={{ height: '100%', background: '#292828', padding: '0 0 0 0' }}>
                        <Barchart data={DataArray} containername={'day quantity rdpo'} por={'Fract'} height={800} />
                      </Card>
                    </Col>
                  </Row>
                </div>
