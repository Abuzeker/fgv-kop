      ...
      <div>
        <Row gutter={[10, 30]} align={'middle'} >
          <Col span={12} xs={24} sm={24} md={24} xl={12} lg={12}>
            ...
            <Card style={{ height: '100%', background: '#706f6f' }}>
              <Carousel fade={true} autoplay autoplaySpeed={50000} >
                <BarchartWithColor data={extractedDataCPO} containername={'cpkouti'} type={'Bleaching Earth Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'cpkouti2'} type={'Elektrik Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'cpkouti3'} type={'Phosphoric Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'cpkouti4'} type={'LNG Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'cpkouti5'} type={'Water Usage (CPO)'} />
              </Carousel>
            </Card>
      ...
      <div>
        <Row gutter={[10, 30]} align={'middle'} >
          <Col span={12} xs={24} sm={24} md={24} xl={12} lg={12}>
            ...
            <Card style={{ height: '100%', background: '#706f6f' }}>
              <Carousel fade={true} autoplay autoplaySpeed={50000} >
                <BarchartWithColor data={extractedDataCPO} containername={'rbdpouti'} type={'Bleaching Earth Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'rbdpouti2'} type={'Elektrik Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'rbdpouti3'} type={'Phosphoric Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'rbdpouti4'} type={'LNG Usage (CPO)'} />
                <BarchartWithColor data={extractedDataCPO} containername={'rbdpouti5'} type={'Water Usage (CPO)'} />
              </Carousel>
            </Card>
...
const Dashboard1 = () => {
  ...
  const request_log = async () => {
    ...
    try {
      ...
      extractedDataRBDPO = extractData(DataArray, 'RDB PO').slice().reverse();
    } catch (error) { }
