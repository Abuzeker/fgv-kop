...
import { saveToLocalStorage } from '../../../Memorystorage/localstorage';
...
const Apitestpage = () => {
    ...
    const request_event = async() =>{
        ...
        if(response.success){
            // saveToLocalStorage("KOP-Token",response.authorization.token)
            console.log(response.authorization.token);
        }
