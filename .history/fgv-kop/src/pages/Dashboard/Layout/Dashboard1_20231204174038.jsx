...
function aggregateAndSortData(originalData) {
    ...
    originalData.data.forEach(item => {
        ...
        if(aggregatedData[date][item.fields.line] != null)
        {
          aggregatedData[date][item.fields.line] = item.fields.value;
    ...
    const result = Object.keys(aggregatedData).map(date => {
        ...
        originalData.data.forEach(item => {
            dataObject[item.fields.parameter] = aggregatedData[date][item.fields.parameter];
        });
