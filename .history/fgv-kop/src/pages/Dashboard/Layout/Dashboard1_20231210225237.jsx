        ...
        <Col span={12} xs={24} sm={24} md={24} xl={12} lg={12}>
          ...
          <Card style={{ height: '100%', background: '#706f6f' }}>
            <Carousel fade={true} autoplay autoplaySpeed={50000} >
              <BarchartWithColor data={extractedDataCPO} containername={'uti'} type={'Bleaching Earth Usage (CPO)'} />
              <BarchartWithColor data={extractedDataCPO} containername={'uti2'} type={'Elektrik Usage (CPO)'} />
              <BarchartWithColor data={extractedDataCPO} containername={'uti3'} type={'Phosphoric Usage (CPO)'} />
              <BarchartWithColor data={extractedDataCPO} containername={'uti4'} type={'LNG Usage (CPO)'} />
              <BarchartWithColor data={extractedDataCPO} containername={'uti5'} type={'Water Usage (CPO)'} />
...
const Dashboard1 = () => {
  ...
  const request_log = async () => {
    ...
    try {
      extractedDataCPO = extractData(DataArray, 'CPO');
      extractedDataCPKO = extractData(DataArray, 'CPKO');
      extractedDataRBDPO = extractData(DataArray, 'RDB PO');
   } catch (error) {}
