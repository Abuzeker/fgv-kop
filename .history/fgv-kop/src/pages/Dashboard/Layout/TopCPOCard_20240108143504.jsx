...
const TopCPOCard = (props) => {
    ...
    const Cpo_produced = parseFloat(props.cposhipment['RBDPL Total Produced']) + 
                         parseFloat(props.cposhipment['RBDPS Total Produced']) +
                         parseFloat(props.cposhipment['PFAD Total Produced'])

    const Cpo_Target   = parseFloat(props.cposhipment['RBDPL Total Target']) + 
                         parseFloat(props.cposhipment['RBDPS Total Target']) +
                         parseFloat(props.cposhipment['PFAD Total Target'])

    const SC = (Cpo_produced/Cpo_Target).toFixed(1)
    console.log((parseFloat(props.cposhipment['RBDPS Total Produced']) + props.cposhipment['RBDPL Total Produced']));
