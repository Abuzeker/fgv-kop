...
import { Individual_Product, MergeAssetandProductLog, MergeOrderandProduct, MergeProductProgress, MergeProducttoAsset, Merge_attainment_to_details, Merge_quatity, OrderInfoRawDataProcess, TenDaysbeforesRange, 
        aggregateAndSortData, chunkArray, filter_unfinish_order, filter_unfinish_order_name, getMonthsRange, 
        getNext10DaysRange, merge_log_and_order } from '../../../DataRequest/LogdataProcess';

import { Caculate_ShipmentCompletion, Find_Latest_data, Sort_Log_by_date, extractData, findHighestTodateCPO } from '../../../DataRequest/UtilityProcess';
...
const Dashboard1 = () => {
  ...
  const request_log = async () => {
    ...
    CPOCardInfo = Find_Latest_data(DataArray)
    ...
    ///order
        ...
        Caculate_ShipmentCompletion(OrderArray)
  ...
  return (
    <Layout className="layout">
      ...
      >
        <TopCPOCard datatodate={highestCPO} datatoday={DataArray} cpolog={cpolog} cporcvLog={cporcvLog} cpocs={cpocs} cpoMA={cpoMA} cpoInfo={CPOCardInfo}></TopCPOCard>
