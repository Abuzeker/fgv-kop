                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpkotinybar'} data={props.cpolog} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpkorcvtinybar'} data={props.cporcvLog} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpkocstinybar'} data={props.cpocs} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpkoAllocationtinybar'} data={props.cpolog} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
