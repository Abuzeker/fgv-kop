...
const utility_carosel = (utilityData) => {
  ...
  const extractedDataCPO = extractData(utilityData, 'CPO');
  const extractedDataCPKO = extractData(utilityData, 'CPKO');
  const extractedDataRBDPO = extractData(utilityData, 'RDB PO');
        ...
        <Col span={12} xs={24} sm={24} md={24} xl={12} lg={12}>
          ...
          <Card style={{ height: '100%', background: '#706f6f' }}>
            <Carousel fade={true} autoplay autoplaySpeed={50000} >
              ...
              <BarchartWithColor data={extractedDataCPO} containername={'uti3'} type={'LNG Usage (CPO)'} />
            </Carousel>
          </Card>
