                ...
                <Layout className="layout">
                    ...
                    >
                        ...
                        <div style={{ textAlign: "center" }}>
                            ...
                            <Button onClick={this.play} style={{ marginRight: '5px',fontSize:'15px' }} type='primary' icon={<PlayCircleOutlined/>}>
                                {/* <PlayCircleOutlined/> */}
                            </Button>

                            <Button onClick={this.pause} style={{ marginRight: '10px',fontSize:'15px' }} type='primary' danger icon={<PauseCircleOutlined />}>
                                {/* <PauseCircleOutlined /> */}
                            </Button>
                        </div>
                    </Header>
