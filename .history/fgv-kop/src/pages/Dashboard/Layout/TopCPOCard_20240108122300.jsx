...
const TopCard = (props) => {
    ...
    // cporcvLog={cporcvLog} cpocs={cpocs} cpoMA={cpoMA} cpoSC={cpoSC}
    let data = {
        'Today (CPO)': 0,
        'Todate (CPO)': 0,
        'CPO Receive': 0,
    ...
    console.log(props.cpocardInfo);
        ...
        try {data['CPO Receive'] = props.datatoday[0]["Today (CPO)"]!== null ? props.datatoday[0]["Today (CPO)"]: 0}catch (error) {console.log(error);}
        try {data['date Today (CPO)'] = props.datatoday[0]["date"]!== null ? props.datatoday[0]["date"]: 0}catch (error) {console.log(error);}
