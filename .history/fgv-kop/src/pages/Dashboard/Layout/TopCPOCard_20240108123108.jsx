...
const TopCard = (props) => {
    ...
    let data = {
        ...
        'CPO Process': props.cpoInfo['CPO PROCESS'],
        'CPO PROCESS Date': props.cpoInfo['CPO PROCESS Date'],
            ...
            <Row gutter={[10, 10]}>
                ...
                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={4}>
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <span style={{ fontSize: '10px', color: 'white' }}>{data['CPO RCV Date']}</span>
                        <div>
                            <Row gutter={16} align={'middle'}>
                                <Col span={12}>
                                    <span style={{ fontSize: '25px', color: 'white' }}>{data['CPO Receive']} MT</span>
                                    <br />
                                    <span style={{ fontSize: '11px' }}>
                                        <InfoCircleOutlined />
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cporcvtinybar'} data={props.cpolog}/>
                                </Col>
                            </Row>
                        </div>
                    </Card>
                ...
                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={4}>
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        <span style={{ fontSize: '20px', color: 'white' }}>Closing Stock </span>
                        <span style={{ fontSize: '10px', color: 'white' }}>{data['date Today (CPO)']}</span>
                        <div>
                            <Row gutter={16} align={'middle'}>
                                <Col span={12}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpoClosingtinybar'} data={props.cpolog}/>
                                </Col>
                            </Row>
                        </div>
                    </Card>
