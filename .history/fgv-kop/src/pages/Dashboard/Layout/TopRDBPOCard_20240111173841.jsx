                        ...
                        <Row>
                            <Col span={6} style={{ borderRight: '1px solid white'}}>
                                ...
                                <Row gutter={16} align={'middle'}>
                                    <Col span={24}>
                                        <br />
                                        <span style={{ fontSize: '25px', color: 'white' }}>{new Intl.NumberFormat().format(data['Todate (RBD PO)'])}</span>
                            ...
                            <Col span={18} style={{ paddingLeft: '20px' }}>
                                ...
                                <div>
                                    <Row gutter={16} align={'middle'}>
                                        <Col span={12}>
                                            <span style={{ fontSize: '25px', color: 'white' }}>{new Intl.NumberFormat().format(data['Today (RBD PO)'])}</span>
                                            <span style={{ fontSize: '15px', color: 'white' }}> MT</span>
                ...
                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={5}>
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                <Col span={12}>
                                    <span style={{ fontSize: '25px', color: 'white' }}>{new Intl.NumberFormat().format(data['RBD PO Receive'])}</span>
                                    <span style={{ fontSize: '15px', color: 'white' }}> MT</span>
                ...
                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={5}>
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                <Col span={12}>
                                    <span style={{ fontSize: '25px', color: 'white' }}>{new Intl.NumberFormat().format(data['RBD PO C/S'])}</span>
                                    <span style={{ fontSize: '15px', color: 'white' }}> MT</span>
