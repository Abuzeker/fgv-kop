                  ...
                  <Row gutter={[20, 10]}>
                    ...
                    <Col span={10} xs={24} sm={24} md={24} lg={24} xl={10}>
                      <Card style={{ height: '100%', background: '#292828', padding: '0 0 0 0' }}>
                        <Barchart data={DataArray} containername={'day quantity'} por={'Refine'} />
                      </Card>
                    </Col>
          ...
          <div>
            ...
            <div style={{ marginBottom: '10px' }}>
              ...
              <Row gutter={[10, 10]}>
                ...
                <Col span={10} xs={24} sm={24} md={24} lg={24} xl={14}>
                  <Card style={{ height: '100%', background: '#292828', padding: '0 0 0 0' }}>
                    <Barchart data={DataArray} containername={'day quantity rdpo'} por={'Fract'} />
                  </Card>
                </Col>
              </Row>
