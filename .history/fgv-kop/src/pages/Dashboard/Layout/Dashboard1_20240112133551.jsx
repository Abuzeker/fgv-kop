  ...
  const request_log = async () => {
    ...
    const cpo_product_wuantity = await Request_dailydata_log(request_range_10,
      ['Today (CPO)', 'Todate (CPO)', 'Bleaching Earth Usage (CPO)',
        ...
        'LNG Usage (CPO)', 'LNG Cost (CPO)', 'Elektric Usage (CPO)', 'Elektric Cost (CPO)',
        ...
        'LNG Usage (CPO) Remark', 'LNG Cost (CPO) Remark', 'Elektric Usage (CPO) Remark', 'Elektric Cost (CPO) Remark',
        ...
        'LNG Usage (CPKO)', 'LNG Cost (CPKO)', 'Elektric Usage (CPKO)', 'Elektric Cost (CPKO)',
        ...
        'LNG Usage (CPKO) Remark', 'LNG Cost (CPKO) Remark', 'Elektric Usage (CPKO) Remark', 'Elektric Cost (CPKO) Remark',
        ...
        'LNG Usage (RBDPO)', 'LNG Cost (RBDPO)', 'Elektric Usage (RBDPO)', 'Elektric Cost (RBDPO)',
