...
const TopCPKOCard = (props) => {
    ...
    console.log(props.cpokInfo);


    let data = {
        'Today (CPKO)': 0,
        'Todate (CPKO)': 0,
        'CPKO Receive': props.cpokInfo['CPKO RCV'],
        'CPKO RCV Date': props.cpokInfo['CPKO RCV Date'],
        'CPKO C/S': props.cpokInfo['CPKO C/S'],
        'CPKO C/S Date': props.cpokInfo['CPKO C/S Date'],
    }

    // console.log(props.datatodate);
    // console.log(props.cposhipment);

    const RBDPL_Total_Produced = parseFloat(props.cpokshipment['RBDPL Total Produced']) || 0;
    const RBDPS_Total_Produced = parseFloat(props.cpokshipment['RBDPS Total Produced']) || 0;
    const PFAD_Total_Produced = parseFloat(props.cpokshipment['PFAD Total Produced']) || 0;
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyProgress containername={'cpotinyprogress'} data={40}/>
                                </Col>
                            </Row>
                        </div>
                    </Card>
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpotinybar'} data={props.cpkolog} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cporcvtinybar'} data={props.cpkorcvLog} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpocstinybar'} data={props.cpkocs} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
                    ...
                    <Card style={{ height: '190px', background: '#292828', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <div>
                            <Row gutter={16} align={'middle'}>
                                ...
                                <Col span={12}>
                                    <TinyBar containername={'cpoAllocationtinybar'} data={props.cpkolog} />
                                </Col>
                            </Row>
                        </div>
                    </Card>
