...
const TopCard = (props) => {
    ...
    try {
        ...
        data['date Today (CPO)'] = props.datatodate[0]["date"]
        data['date Today (CPKO)'] = props.datatodate[0]["date"]
        data['date Today (RBD PO)'] = props.datatodate[0]["date"]
    } catch (error) {
            ...
            <Row gutter={[10, 10]}>
                ...
                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={4}>
                    <Card style={{ height: '190px', background: '#706f6f', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        ...
                        <span style={{ fontSize: '10px' }}>{data['date today (CPO)']}</span>
                        <div>
                            <Row gutter={16} align={'middle'}>
                                <Col span={12}>
