...
const TopCPOCard = (props) => {
    ...
    const RBDPL_Total_Produced = parseFloat(props.cposhipment['RBDPL Total Produced']);
    const RBDPS_Total_Produced = parseFloat(props.cposhipment['RBDPS Total Produced']);
    const PFAD_Total_Produced = parseFloat(props.cposhipment['PFAD Total Produced']);
    
    console.log('RBDPL_Total_Produced:', RBDPL_Total_Produced);
    console.log('RBDPS_Total_Produced:', RBDPS_Total_Produced);
    console.log('PFAD_Total_Produced:', PFAD_Total_Produced);
    
    const Cpo_produced = RBDPL_Total_Produced + RBDPS_Total_Produced + PFAD_Total_Produced;
    
    const RBDPL_Total_Target = parseFloat(props.cposhipment['RBDPL Total Target']);
    const RBDPS_Total_Target = parseFloat(props.cposhipment['RBDPS Total Target']);
    const PFAD_Total_Target = parseFloat(props.cposhipment['PFAD Total Target']);
    
    console.log('RBDPL_Total_Target:', RBDPL_Total_Target);
    console.log('RBDPS_Total_Target:', RBDPS_Total_Target);
    console.log('PFAD_Total_Target:', PFAD_Total_Target);
    
    const Cpo_Target = RBDPL_Total_Target + RBDPS_Total_Target + PFAD_Total_Target;
    
    const SC = (Cpo_produced / Cpo_Target).toFixed(1);
    
    console.log('Cpo_produced:', Cpo_produced);
    console.log('Cpo_Target:', Cpo_Target);
    console.log('SC:', SC);
