...
const TopCard = (props) => {
    ...
    try {
        console.log( props.datatodate[2]["Todate (RBD PO)"]);
        data['Todate (CPO)'] = props.datatodate[0]["Todate (CPO)"] ? props.datatodate[0]["Todate (CPO)"]: 0
        data['Todate (CPKO)'] = props.datatodate[1]["Todate (CPKO)"] ? props.datatodate[1]["Todate (CPKO)"]: 0
        data['Todate (RBD PO)'] = props.datatodate[2]["Todate (RBD PO)"] ? props.datatodate[2]["Todate (RBD PO)"]: 0

        data['date todate (CPO)'] = props.datatodate[0]["date"] ? props.datatodate[0]["date"]: 0
        data['date todate (CPKO)'] = props.datatodate[1]["date"] ? props.datatodate[1]["date"]: 0
        data['date todate (RBD PO)'] = props.datatodate[2]["date"] ? props.datatodate[2]["date"]: 0

        data['Today (CPO)'] = props.datatoday[0]["Today (CPO)"] ? props.datatoday[0]["Today (CPO)"]: 0
        data['Today (CPKO)'] = props.datatoday[0]["Today (CPKO)"] ? props.datatoday[0]["Today (CPKO)"] : 0
        data['Today (RBD PO)'] = props.datatoday[0]["Today (RBD PO)"] ? props.datatoday[0]["Today (RBD PO)"] : 0

        data['date Today (CPO)'] = props.datatoday[0]["date"] ? props.datatoday[0]["date"]: 0
        data['date Today (CPKO)'] = props.datatoday[0]["date"] ? props.datatoday[0]["date"]: 0
        data['date Today (RBD PO)'] = props.datatoday[0]["date"] ? props.datatoday[0]["date"]: 0
