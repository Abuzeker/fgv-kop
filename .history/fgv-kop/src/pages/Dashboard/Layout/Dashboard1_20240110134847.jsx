          ...
          <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
            ...
            <div>
              <Row gutter={[10, 10]}>
                <Col span={16}>
                  <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti4'} type={'LNG Usage (CPKO)'} />
                  </Card>
                </Col>
                <Col span={8}>
                  <RemarkTable />
            ...
            <div>
              <Row gutter={[10, 10]}>
                <Col span={16}>
                  <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti5'} type={'Water Usage (CPKO)'} />
                  </Card>
                </Col>
                <Col span={8}>
                  <RemarkTable />
        ...
        <Carousel fade={true} autoplay autoplaySpeed={30000}>
          <div>
            ...
            <div className="site-layout-content">
              ...
              <Carousel fade={true} autoplay autoplaySpeed={30000} style={{paddingbottom:'100px'}}>
