  ...
  const request_log = async () => {
    ...
    const cpo_product_wuantity = await Request_dailydata_log(request_range_10,
      ['Today (CPO)', 'Todate (CPO)', 'Bleaching Earth Usage (CPO)',
        ...
        'LNG Usage (CPO)', 'LNG Cost (CPO)', 'Elektrik Usage (CPO)', 'Elektric Cost (CPO)',
        ...
        'LNG Usage (CPO) Remark', 'LNG Cost (CPO) Remark', 'Elektrik Usage (CPO) Remark', 'Elektric Cost (CPO) Remark',
        ...
        'LNG Usage (CPKO)', 'LNG Cost (CPKO)', 'Elektrik Usage (CPKO)', 'Elektric Cost (CPKO)',
        ...
        'LNG Usage (CPKO) Remark', 'LNG Cost (CPKO) Remark', 'Elektrik Usage (CPKO) Remark', 'Elektric Cost (CPKO) Remark',
        ...
        'LNG Usage (RBD PO)', 'LNG Cost (RBD PO)', 'Elektrik Usage (RBD PO)', 'Elektric Cost (RBD PO)',
        'Water Usage (RBD PO)', 'Water Cost (RBD PO)', 'Total Cost (RBD PO)', 'RBD PO Total',
