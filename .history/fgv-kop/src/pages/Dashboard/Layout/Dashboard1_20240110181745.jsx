    ...
    <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
      <div>
        ...
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'crbdpouti'} type={'Bleaching Earth Usage (RBD PO)'} range={[6.01, 7.01]} height={800}/>
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'crbdpoti2'} type={'Electric Usage (RBD PO)'} range={[14.01, 15.01]} height={800}/>
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'rbdpoti3'} type={'Phosphoric Usage (RBD PO)'} range={[0.55, 0.65]} height={800}/>
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'rbdpouti4'} type={'LNG Usage (RBD PO)'} range={[12.01, 12.99]} height={800}/>
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
      ...
      <div>
        <Row gutter={[10, 10]}>
          <Col span={16}>
            <Card style={{ height: '100%', background: '#292828' }}>
              <BarchartWithColor data={extractedDataRBDPO} containername={'rbdpoti5'} type={'Water Usage (RBD PO)'} range={[0.2, 0.3]} height={800}/>
            </Card>
          </Col>
          <Col span={8}>
            <RemarkTable />
