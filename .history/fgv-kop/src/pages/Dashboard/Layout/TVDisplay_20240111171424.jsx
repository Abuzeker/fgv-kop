                ...
                <Layout className="layout">
                    ...
                    >
                        ...
                        <div style={{ textAlign: "center" }}>
                            ...
                            <Button onClick={this.play} style={{ marginRight: '5px' }} type='primary'>
                                <PlayCircleOutlined size={100}/>
                            </Button>

                            <Button onClick={this.pause} style={{ marginRight: '10px' }} type='primary' danger>
                                <PauseCircleOutlined />
                            </Button>
                        </div>
                    </Header>
