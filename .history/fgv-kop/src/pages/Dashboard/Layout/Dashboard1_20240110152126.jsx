          ...
          <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
              ...
              <Row gutter={[10, 10]}>
                <Col span={16}>
                  <Card style={{ height: '100%', background: '#292828' }}>
                    <BarchartWithColor data={extractedDataCPO} containername={'cpouti'} type={'Bleaching Earth Usage (CPO)'} range={[6,7]}/>
                  </Card>
                </Col>
                <Col span={8}>
                  <RemarkTable />
            ...
            <div>
              <Row gutter={[10, 10]}>
                <Col span={16}>
                  <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti2'} type={'Electric Usage (CPO)'} range={[14,15]}/>
                  </Card>
                </Col>
                <Col span={8}>
                  <RemarkTable />
            ...
            <div>
              <Row gutter={[10, 10]}>
                <Col span={16}>
                  <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti4'} type={'LNG Usage (CPKO)'} range={[12.01,12.99]}/>
                  </Card>
                </Col>
                <Col span={8}>
                  <RemarkTable />
            ...
            <div>
              <Row gutter={[10, 10]}>
                <Col span={16}>
                  <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPO} containername={'cpouti5'} type={'Water Usage (CPKO)'} range={[0.2,0.3]}/>
                  </Card>
                </Col>
                <Col span={8}>
                  <RemarkTable />
