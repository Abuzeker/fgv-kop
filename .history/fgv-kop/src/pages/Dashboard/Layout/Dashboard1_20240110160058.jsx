        ...
        <Carousel fade={true} autoplay autoplaySpeed={3000} dotPosition='left'>
          ...
          <div>
            <Row gutter={[10, 10]}>
              <Col span={16}>
                <Card style={{ height: '100%', background: '#292828' }}>
                  <BarchartWithColor data={extractedDataCPKO} containername={'cpkouti2'} type={'Elektrik Usage (CPKO)'} range={[14, 15]} />
                </Card>
              </Col>
              <Col span={8}>
                <RemarkTable />
                ...
                <div style={{ marginBottom: '10px' }}>
                  ...
                  <Row gutter={[20, 10]}>
                    ...
                    <Col span={14} xs={24} sm={24} md={24} lg={24} xl={14}>
                      <Card style={{ height: '100%', background: '#292828' }} bodyStyle={{ padding: '0 0 0 10'}}>
