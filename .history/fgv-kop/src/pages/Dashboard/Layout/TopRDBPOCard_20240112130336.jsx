...
const TopRBDPOCard = (props) => {
    ...
    try { data['Today (RBDPO)'] = props.datatoday[2]["Today (RBDPO)"] !== null ? props.datatoday[2]["Today (RBDPO)"] : 0 } catch (error) { console.log(error); }
    try { data['date Today (RBDPO)'] = props.datatoday[2]["date"] !== null ? props.datatoday[2]["date"] : 0 } catch (error) { console.log(error); }
