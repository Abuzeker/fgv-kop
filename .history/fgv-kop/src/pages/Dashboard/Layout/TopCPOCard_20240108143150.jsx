...
const TopCPOCard = (props) => {
    ...
    const Cpo_produced = props.cposhipment['RBDPL Total Produced'] + props.cposhipment['RBDPS Total Produced'] +props.cposhipment['PFAD Total Produced']
    const Cpo_Target   = props.cposhipment['RBDPL Total Target'] + props.cposhipment['RBDPS Total Target'] +props.cposhipment['PFAD Total Target']
