...
const OrderSummary = (props) => {
   ...
   const orderpercent = orderinfo['Attainment Rate']? orderinfo['Attainment Rate'] : 0.0
    ...
    return (
        <div>
            ...
            <Col span={6} xs={24} sm={12} md={12} lg={8} xl={4}>
                <Card style={{ height: '300px', width: '260px', background: '#706f6f', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
