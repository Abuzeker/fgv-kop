    ...
    return (
        <div>
            ...
            <Col span={6} xs={24} sm={12} md={12} lg={8} xl={4}>
                <Card style={{ height: '300px', width: '290px', background: '#706f6f', color: 'white', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', border: '1px solid #e8e8e8', }}>
                        <Row gutter={[16, 10]} align={'middle'}>
                            ...
                            <Col span={24} align={'middle'}>
                                ...
                                <Progress type="circle" percent={orderinfo['Attainment Rate']} strokeColor={twoColors} size={[100, 50]} strokeWidth={10} style={{color:'white'}}/>
                            </Col>
                        </Row>
                </Card>
            </Col>
