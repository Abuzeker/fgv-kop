...
import { BarGraphDataProcess, Individual_Product, LineGraphDataProcess, MergeAssetandProductLog, 
    ...
    getMonthsRange, getNext10DaysRange, merge_log_and_order } from '../../../DataRequest/LogdataProcess';
...
const PurchaseOrderProgress = () => {
    ...
    const request_orderinfo_event = async () => {
        ...
        ShipmentCompletionRatio = CPOShipmentCompletion['Ratio']*100
                        ...
                        <Col span={24}>
                            <Card style={{ fill: 'ActiveBorder', background: '#292828', height: '550px' }}>
                                <span style={{ fontWeight: 'bold', fontSize: '25px', color: 'white' }}>
                                    Cargo Readiness ( Overall Shipment Completion {ShipmentCompletionRatio} %)
                                </span>
                                <div style={{ marginBottom: '20px' }} ></div>
