            ...
            <Row gutter={16}>
                <Col span={24}>
                    <Space direction="vertical" size="small" style={{ display: 'flex', color: 'white' }}>
                        ...
                        <div style={{ paddingTop: '8px', fontWeight: 'bold', padding: ' 5px 0px 0px 0px' }}>
                            <span style={{ fontSize: '10px', color: 'white' }}>Order Progress</span>
                            <Progress percent={70.9} strokeColor={twoColors} size={'large'} strokeWidth={10} format={customFormat} />
                        </div>
