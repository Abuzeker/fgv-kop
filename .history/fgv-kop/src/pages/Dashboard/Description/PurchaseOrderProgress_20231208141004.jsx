...
const PurchaseOrderProgress = () => {
    ...
    const request_orderinfo_event = async () => {
        ...
        const response_order_quantity = await Request_data_log(daterange, ["Todate Quantity", "Today Quantity", "Today Targeted Quantity","Todate Quantity (RBDPO)", "Todate Quantity (RBDPL)",
        "Todate Quantity (RBDPS)", "Todate Quantity (PFAD)"], [])
