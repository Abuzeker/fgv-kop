...
import { Merge_attainment_to_details, Merge_quatity, OrderInfoRawDataProcess } from '../../../DataRequest/LogdataProcess';
...
function transformData(originalData) {
    ...
    originalData.data.forEach(item => {
        const assetInfo = parseAssetInfo(item.fields.asset);
