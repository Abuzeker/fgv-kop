...
import { BarGraphDataProcess, Individual_Product, LineGraphDataProcess, MergeProductProgress, MergeProducttoAsset, Merge_attainment_to_details, Merge_quatity, OrderInfoRawDataProcess, Sort_log_with_asset, getSixMonthsRange, merge_log_and_order } from '../../../DataRequest/LogdataProcess';
...
const PurchaseOrderProgress = () => {
    ...
    const request_orderinfo_event = async () => {
        ...
        MergeProductProgress(asset_product,OrderProducts)
