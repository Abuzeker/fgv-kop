...
import { BarGraphDataProcess, Individual_Product, LineGraphDataProcess, MergeAssetandProductLog, 
    ...
    Merge_quatity, OrderInfoRawDataProcess, Sort_log_with_asset, chunkArray, filter_unfinish_order, filter_unfinish_order_name, getSixMonthsRange, merge_log_and_order } from '../../../DataRequest/LogdataProcess';
...
const PurchaseOrderProgress = () => {
    ...
    const request_orderinfo_event = async () => {
        ...
        const daterange = getSixMonthsRange(6)
