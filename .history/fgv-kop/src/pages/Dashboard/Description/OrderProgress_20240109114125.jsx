                        ...
                        <Space direction="vertical" size="small" style={{ display: 'flex', color: 'white' }}>
                            ...
                            <Row gutter={[10, 10]}>
                                ...
                                <Col span={8}>
                                    <Statistic
                                        valueStyle={{ fontSize: '25px', color: 'white' }}
                                        title={<span style={{ color: 'white', fontSize: '22px' }}>Balanced </span>}
                                        value={Remaing}
                                        suffix={<span style={{ fontSize: '15px', color: 'white' }}>MT</span>}
                                    />
                                </Col>
                            ...
                            <div style={{ fontWeight: 'bold', padding: ' 5px 0px 0px 0px' }}>
                                ...
                                <Progress percent={Orderdetails['Attainment Rate']} strokeColor={twoColors} size={'large'} strokeWidth={13} format={customFormat} />
                            </div>
