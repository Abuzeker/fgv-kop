        ...
        <div style={{ marginTop: '0px', marginBottom: '25px', padding: '0 0px' }}>
            <div>
                <Row gutter={[15, 10]} align={'top'}>
                    <Col span={12}>
                        <Divider orientation='left' style={{color:'white'}}>Order Detail</Divider>

                        <Card style={{backgroundColor: '#151921'}} bordered={false}>
                            <Row gutter={[10, 10]}>
                                <Col span={24}>
                                    <Row gutter={[10, 0]}>
                                        <Col span={8}>
                                ...
                                <Col span={24}>
                                    ...
                                    <Row gutter={[10, 10]}>
                                        <Col span={12}>
                                            <Card style={{ fill: 'ActiveBorder', background: 'rgba(247, 247, 247, 1)', height: '620px' }}>
