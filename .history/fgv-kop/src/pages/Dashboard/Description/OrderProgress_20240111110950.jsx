                            ...
                            <Row gutter={[10, 10]}>
                                ...
                                <Col span={8}>
                                    <Statistic
                                        ...
                                        title={<span style={{ color: 'white', fontSize: '22px' }}>Todate </span>}
                                ...
                                <Col span={8}>
                                    <Statistic
                                        valueStyle={{ fontSize: '25px', color: 'white' }}
                                        title={<span style={{ color: 'white', fontSize: '22px' }}>Today Quantity </span>}
                            ...
                            <Space direction="horizontal" size={40} style={{ display: 'flex', color: 'white' }}>
                                ...
                                <Row gutter={[130, 10]}>
                                    <Col span={12}>
                                        ...
                                        <Statistic
                                            valueStyle={{ fontSize: '19px', fontWeight: 600, color: 'white' }}
                                    ...
                                    <Col span={12}>
                                        <Statistic
                                            valueStyle={{ fontSize: '19px', color: 'white' }}
                                            title={<span style={{ color: 'white', fontSize: '16px' }}>Today Efficiency</span>}
                                            value={today_eff}
                                            suffix={'%'}
                                            prefix={<CheckCircleFilled style={{ color: 'white', fontSize: '16px' }} />}
                                        />
                                    </Col>
                                </Row>
