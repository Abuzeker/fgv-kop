...
const OrderProgress = (props) => {
    ...
    let today_eff = parseFloat(Orderdetails['Today Quantity'] / Orderdetails['Today Targeted Quantity']).toFixed(3) * 100
    if (isNaN(today_eff)) {
        today_eff = 0;
    }
    ...
    const laycanStartDate = '30/11/2023';
    const laycanEndDate = '30/11/2023';
