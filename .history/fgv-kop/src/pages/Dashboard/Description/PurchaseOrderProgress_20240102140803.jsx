...
import { BarGraphDataProcess, Individual_Product, LineGraphDataProcess, MergeAssetandProductLog, 
    ...
    Merge_quatity, OrderInfoRawDataProcess, Sort_log_with_asset, chunkArray, filter_unfinish_order, filter_unfinish_order_name, getMonthsRange, getNext10DaysRange, merge_log_and_order } from '../../../DataRequest/LogdataProcess';
        ...
        <Row gutter={16}>
            <Col span={24}>
                ...
                <Space direction="vertical" size="small" style={{ display: 'flex', color: 'white' }}>
                    ...
                    <div style={{ paddingTop: '5px', fontWeight: 'bold', padding: ' 1px 0px 0px 0px' }}>
