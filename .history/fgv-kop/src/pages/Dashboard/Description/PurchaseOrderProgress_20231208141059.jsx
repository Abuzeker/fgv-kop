...
const PurchaseOrderProgress = () => {
    ...
    const request_orderinfo_event = async () => {
        ...
        const response_order_quantity = await Request_data_log(daterange, ["Todate Quantity", "Today Quantity", 
        "Today Targeted Quantity","Today Quantity (RBDPO)", "Today Quantity (RBDPL)",
        "Today Quantity (RBDPS)", "Today Quantity (PFAD)"], [])
