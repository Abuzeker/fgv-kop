...
import { Merge_attainment_to_details, Merge_quatity, OrderInfoRawDataProcess, Sort_log_with_asset } from '../../../DataRequest/LogdataProcess';
                    ...
                    <Row gutter={[10, 10]}>
                        ...
                        <Col span={12} xs={24} lg={12}>
                            <Card style={{ fill: 'ActiveBorder', background: '#706f6f', height: '620px' }}>
                                ...
                                <BarchartWithColor containername={`chart-${OrderInfo.Asset}`} />
                            </Card>
                        </Col>
                    </Row>
                </Col>
...
const PurchaseOrderProgress = () => {
    ...
    const request_orderinfo_event = async () => {
        ...
        // const transformedData = transformData(response_order_quantity);
        ...
        const wr = Sort_log_with_asset(response_order_quantity,`b2:b2:[RBDPS, PFAD, RBDPL]:["2023-11-29T16:00:00Z","2023-11-29T16:00:00Z"]:444ton`)
        console.log(wr);
