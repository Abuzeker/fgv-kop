...
import { BarGraphDataProcess, LineGraphDataProcess, Merge_attainment_to_details, Merge_quatity, OrderInfoRawDataProcess, Sort_log_with_asset, merge_log_and_order } from '../../../DataRequest/LogdataProcess';
                            ...
                            <Card style={{ fill: 'ActiveBorder', background: '#706f6f', }}>
                                <Carousel fade>
                                    ...
                                    <div style={{ marginBottom: '20px' }}>
                                        ...
                                        <MultiBar containername={'ser'} Oridata = {OrderArray}/>
