...
const L1500Card = () => {
    ...
    return (
        <div>
            <HMIWrapper Tab={['Deodorization 1', 'Deodorization 2', 'Ice Condensation', 'Bleaching', 'G331AHMI', 'G331BHMI', 'Vacuum']}>
                <IceCondesHMI key={'Ice Condensation'} value={L1500_IceD_Condeser}/>
