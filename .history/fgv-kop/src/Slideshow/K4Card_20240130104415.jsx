...
const K4Card = () => {
  ...
  const request_realtime = async () => {
    ...
    FilteredC123 = Merge_parameter_name_and_value_line(Request_Realtime_HMI,["CRYSTALLIZER 1","CRYSTALLIZER 2","CRYSTALLIZER 3"])
    FilteredC456 = Merge_parameter_name_and_value_line(Request_Realtime_HMI,["CRYSTALLIZER 4","CRYSTALLIZER 5","CRYSTALLIZER 6"])
    FilteredC789 = Merge_parameter_name_and_value_line(Request_Realtime_HMI,["CRYSTALLIZER 7","CRYSTALLIZER 8","CRYSTALLIZER 9"])

    FilteredStearine = Merge_parameter_name_and_value_line(Request_Realtime_HMI,["FT5A","FT5B","FT5C","FT6","FT4"])
    FilteredChiller = Merge_parameter_name_and_value_line(Request_Realtime_HMI,["COOLING TOWER","FT9","FT8"])
