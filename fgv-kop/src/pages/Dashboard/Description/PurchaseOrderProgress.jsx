                        ...
                        <Col span={12} xs={24} lg={12}>
                            ...
                            <div>
                                ...
                                <Card style={{ fill: 'ActiveBorder', background: '#292828', color: 'white', height: '620px' }}>
                                    ...
                                    {
                                        OrderInfo['Todate Produced'] && OrderInfo['Todate Produced'].map((element, index) => (
                                            <div key={index}>
                    ...
                    <Row gutter={[10, 0]}>
                        <Col span={8}>
                            <Statistic
                                ...
                                title={<span style={{ color: 'white', fontSize: '18px' }}> Shipment Quantity</span>}
                        ...
                        <Col span={8}>
                            <Statistic
                                valueStyle={{ color: 'white', fontSize: '20px' }}
                                title={<span style={{ color: 'white', fontSize: '18px' }}>To Date </span>}
                        ...
                        <Col span={8}>
                            <Statistic
                                valueStyle={{ color: 'white', fontSize: '20px' }}
                                title={<span style={{ color: 'white', fontSize: '18px' }}>Balance </span>}
